...
public class DoorbellSubmitRequest {
  ...
  /**
   * The sentiment of the message, if you don't want this analyzed automatically. The possible
   * values are: positive, neutral, or negative
   */
  private Sentiment sentiment;

  /**
   * JSON encoded array of strings, or a comma separated string of tags you want to add to the
   * feedback
   */
  private List<String> tags;

  /**
   * JSON encoded string of properties (of any data type), any extra metadata you want to attach to
   * the message
   */
  ...
  /**
   * The language the site/app is using. The response messages will be in the corresponding
   * language, if translated
   */
  ...
  public DoorbellSubmitRequest setSentiment(final Sentiment sentiment) {
