...
@NotThreadSafe public class ActionEditActivity extends AbstractAppCompatPluginActivity {
  ...
  @Override protected void onCreate(final Bundle savedInstanceState) {
    ...
    mCommandConfigurationVariable.setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override public void onCheckedChanged(CompoundButton compoundButton, boolean newValue) {
            if (newValue) {
  ...
  @Override public void onPostCreateWithPreviousResult(@NonNull final Bundle previousBundle,
  ...
  @Override public boolean isBundleValid(@NonNull final Bundle bundle) {
    return PluginBundleValues.isBundleValid(bundle);
  }

  @Nullable @Override public Bundle getResultBundle() {
  ...
  @NonNull @Override public String getResultBlurb(@NonNull final Bundle bundle) {
