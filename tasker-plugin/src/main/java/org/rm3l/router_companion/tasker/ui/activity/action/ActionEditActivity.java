...
public class ActionEditActivity extends AbstractAppCompatPluginActivity {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
              ...
              if (position == routersNamesArray.length - 1) {
                ...
                try {
                  ...
                  if (TextUtils.isEmpty(ddwrtCompanionAppPackage)) {
                    ActivityUtils.openPlayStoreForPackage(
                        ActionEditActivity.this, "org.rm3l.ddwrt");
                ...
                mSelectedRouterReadableName =
                    String.format(
                        ...
                        routerInfo.isDemoRouter()
                            ? "DEMO"
                            : String.format(
                                "%s:%d",
                                routerInfo.getRemoteIpAddress(), routerInfo.getRemotePort()));
              }
            }
      ...
      if (!reloading) {
        ...
        final ArrayAdapter<String> cmdAdapter =
            new ArrayAdapter<>(
                ActionEditActivity.this, R.layout.spinner_item, supportedCommandsArr);
        ...
        mCommandsDropdown.setOnItemSelectedListener(
            new AdapterView.OnItemSelectedListener() {
              @Override
              public void onItemSelected(
                  AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (supportedCommand) {
                  case CUSTOM_COMMAND:
                    mCommandConfigurationVariable.setChecked(
        ...
        FirebaseCrashlytics.getInstance()
            .log(
                "mPreviousBundleCommandCustomVariableName: "
                    + mPreviousBundleCommandCustomVariableName);
        FirebaseCrashlytics.getInstance()
            .log("mPreviousBundleCommandCustomCmd: " + mPreviousBundleCommandCustomCmd);
        ...
        if (mPreviousBundleCommandSupportedParamHint != null) {
          ...
          if (mPreviousBundleCommandSupportedParamIsVariable) {
            mCommandParamEditText.setText(
                mPreviousBundleCommandSupportedParamVariableName, EDITABLE);
          } else {
  ...
  public enum SupportedCommand {
    ...
    RESET_BANDWIDTH_COUNTERS(
        "Reset Bandwidth Counters", false, "reset-bandwidth-counters", null, null),
    ...
    ENABLE_WAN_TRAFFIC_COUNTERS(
        "Enable WAN Traffic counters", false, "enable-wan-traffic-counters", null, null),
    DISABLE_WAN_TRAFFIC_COUNTERS(
        "Disable WAN Traffic counters", false, "diable-wan-traffic-counters", null, null),
    ENABLE_SYSLOGD("Enable Syslog", false, "enable-syslog", null, null),
    DISABLE_SYSLOGD("Disable Syslog", false, "disable-syslog", null, null),
    ENABLE_DEVICE_WAN_ACCESS(
        "Enable WAN Access for Device",
        true,
        "enable-device-wan-access",
        "mac",
        "Device MAC Address"),
    DISABLE_DEVICE_WAN_ACCESS(
        "Disable WAN Access for Device",
        true,
        "disable-device-wan-access",
        "mac",
        "Device MAC Address"),
    ESABLE_WAN_ACCESS_POLICY(
        "Enable WAN Access Policy", true, "enable-wan-access-policy", "policy", "Policy Name"),
    DISABLE_WAN_ACCESS_POLICY(
        "Disable WAN Access Policy", true, "disable-wan-access-policy", "policy", "Policy Name");

    @NonNull public final String actionName;

    @Nullable public final String humanReadableName;

    public final boolean isConfigurable;

    @Nullable public final String paramHumanReadableHint;

    @Nullable public final String paramName;

    SupportedCommand(
        @Nullable String humanReadableName,
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    mErrorPlaceholder.setOnClickListener(
    ...
    mReturnOutputCheckbox.setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override
          public void onCheckedChanged(CompoundButton compoundButton, boolean newValue) {
  ...
  public Bundle getResultBundle() {
    ...
    return PluginBundleValues.generateBundle(
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    ...
    if (i
        == android.R.id.home) { // Signal to AbstractAppCompatPluginActivity that the user canceled.
      mIsCancelled = true;
      onBackPressed();
      ...
      new LibsBuilder()
        ...
        == R.id.menu_discard_changes) { // Signal to AbstractAppCompatPluginActivity that the user
      // canceled.
      mIsCancelled = true;
      finish();
