...
public class RouterInfo implements Parcelable {
  ...
  public static final Creator<RouterInfo> CREATOR = new Creator<RouterInfo>() {
    @Override public RouterInfo createFromParcel(Parcel in) {
      return new RouterInfo(in);
    }

    @Override public RouterInfo[] newArray(int size) {
  ...
  @NonNull public String getRouterConnectionProtocol() {
  ...
  @NonNull public boolean isDemoRouter() {
    return isDemoRouter;
  }
