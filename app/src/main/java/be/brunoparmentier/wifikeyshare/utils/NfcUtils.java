...
public final class NfcUtils {
  ...
  public static boolean hasNFCHardware(@Nullable final Context context) {
    ...
    final boolean hasNfcSystemFeature =
   ...
   *
   * <p>The tag is NDEF-formatted with the application/vnd.wfa.wsc MIME type
   *
   ...
   *
   * <p>Source:
   * http://androidxref.com/6.0.1_r10/xref/packages/apps/Nfc/src/com/android/nfc/NfcWifiProtectedSetup.java
   *
   ...
   *
   * <p>The NDEF message should contain two NDEF records: the actual Wi-Fi configuration and an AAR
   * (Android Application Record) with the application package id. If the message size is greater
   * than the maximum writable size, the AAR is removed from the NDEF message. If it is still too
   * big, the message is not written.
   *
