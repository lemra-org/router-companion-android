 ...
 */
public class StatusRouterCPUTile extends DDWRTTile<Object> {

//    Drawable icon;

    public StatusRouterCPUTile(@NotNull SherlockFragmentActivity parentFragmentActivity, @NotNull Bundle arguments) {
