...
public class ArpPingFromRouterAction extends ExecStreamableCommandRouterAction {
    ...
    public ArpPingFromRouterAction(Router router, @NonNull Context context, @Nullable RouterStreamActionListener listener,
                                   @NonNull final SharedPreferences globalSharedPreferences,
                                   @NonNull final String hostToPing) {
        super(router, RouterAction.ARPING, context, listener, globalSharedPreferences,
