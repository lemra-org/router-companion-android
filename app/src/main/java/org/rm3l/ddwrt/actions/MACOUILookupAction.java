...
public class MACOUILookupAction extends AbstractRouterAction<Void> {
    ...
    protected RouterActionResult<Void> doActionInBackground(@NonNull Router router) {
        ...
        try {
            ...
            final MACOUIVendor macouiVendor = WirelessClientsTile.mMacOuiVendorLookupCache.get(mMacAddress);
            ...
            if (routerStreamActionListener != null) {
                routerStreamActionListener.notifyRouterActionProgress(RouterAction.MAC_OUI_LOOKUP, router, 100, macouiVendor
