...
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_CONFIG;
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_CRL;
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_DH;
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_ENABLE;
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_KEY;
import static org.rm3l.ddwrt.resources.conn.NVRAMInfo.OPENVPN_ONWAN;
    ...
    protected Loader<NVRAMInfo> getLoader(int id, Bundle args) {
        mLoader = new AsyncTaskLoader<NVRAMInfo>(this.mParentFragmentActivity) {
            ...
            public NVRAMInfo loadInBackground() {
                ...
                try {
                    Log.d(LOG_TAG, "Init background loader for " + OpenVPNServerTile.class + ": routerInfo=" +
    ...
    private class ManageOpenVPNServerToggle implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (!(view instanceof CompoundButton)) {
                Utils.reportException(new IllegalStateException("ManageOpenVPNServerToggle#onClick: " +
