...
public class RouterActionsDeepLinkActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (!getSharedPreferences(DEFAULT_SHARED_PREFERENCES_KEY, Context.MODE_PRIVATE)
        .getBoolean(SECURITY_THIRD_PARTY_INTEGRATION, false)) {
  ...
  private boolean handleParametersUponPasswordCheck() {
    ...
    if (mRouters.isEmpty()) {
      FirebaseCrashlytics.getInstance()
          .log("No routers found matching this query: " + routerUuidOrRouterName);
      if (BuildConfig.DEBUG) {
        Toast.makeText(
                this,
    ...
    for (final Router router : mRouters) {
      ...
      final RouterActionListener routerActionListener =
      ...
      switch (action) {
        case EXEC_CUSTOM:
          ...
          routerAction =
              new ExecuteCommandRouterAction(
                  router,
        ...
        case EXEC_FILE:
          ...
          routerAction =
              new UploadAndExecuteScriptRouterAction(
                  router,
                  RouterActionsDeepLinkActivity.this,
                  routerActionListener,
                  globalPrefs,
        ...
        case RESTART:
          routerAction =
              new RebootRouterAction(
                  router, RouterActionsDeepLinkActivity.this, routerActionListener, globalPrefs);
          break;
        ...
        case ERASE_WAN_TRAFFIC:
          routerAction =
              new EraseWANMonthlyTrafficRouterAction(
                  router, RouterActionsDeepLinkActivity.this, routerActionListener, globalPrefs);
          break;
        ...
        case WOL:
          {
            final String deviceMac =
                Strings.nullToEmpty(mParameters.getString("mac")).toLowerCase();
                    ...
                    new RouterActionListener() {
                      ...
                      public void onRouterActionSuccess(
                        ...
                        if (!(returnData instanceof Map)) {
                          FirebaseCrashlytics.getInstance()
                              .log("returnData is NOT an instance of Map");
                          routerActionListener.onRouterActionFailure(
                              routerAction,
                              router,
                        ...
                        if (!(resultForRouter instanceof String[])) {
                          FirebaseCrashlytics.getInstance()
                              .log("resultForRouter is NOT an instance of String[]");
                          routerActionListener.onRouterActionFailure(
                              routerAction,
                              router,
        ...
        case DISABLE_OPENVPNC:
          {
            ...
            nvramInfo.setProperty(
                NVRAMInfo.Companion.getOPENVPNCL_ENABLE(), action.startsWith("enable") ? "1" : "0");
            routerAction =
                  ...
                  new RouterActionListener() {
                    ...
                    public void onRouterActionSuccess(
                      ...
                      if (policies.length == 0) {
                        ...
                        routerActionListener.onRouterActionFailure(
                            routerAction, router, new IllegalArgumentException("No Policy found"));
                        return;
                      }
                      ...
                      for (final Map.Entry<Object, Object> entry : entries) {
                        ...
                        final int keyNb =
                            Integer.parseInt(keyStr.replace("filter_rule", "").trim());
                        ...
                        final int enableStatus =
                            !enable
                                ? DISABLE
                                : WANAccessPolicy.Companion.getDENY()
                                        .equals(wanAccessPolicy.getDenyOrFilter())
                                    ? ENABLE_1
                                    : ENABLE_2;
                        ActionManager.runTasks(
