...
public class PPTPClientTile extends DDWRTTile<NVRAMInfo> {
    ...
    public PPTPClientTile(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
                    ...
                    try {
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                ...
                                editor.putStringSet("EditPPTPClientSettingsRemoteServer",
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                mGlobalPreferencesStringSet.add(property);
                                editor.putStringSet("EditPPTPClientSettingsRemoteServerSubnet",
                                        mGlobalPreferencesStringSet);
                                applyNewPrefs = true;
                            }
                        }
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                mGlobalPreferencesStringSet.add(property);
                                editor.putStringSet("EditPPTPClientSettingsRemoteServerSubnetMask",
                                        mGlobalPreferencesStringSet);
                                applyNewPrefs = true;
                            }
                        }
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                mGlobalPreferencesStringSet.add(property);
                                editor.putStringSet("EditPPTPClientSettingsRemoteServerMTU",
                                        mGlobalPreferencesStringSet);
                                applyNewPrefs = true;
                            }
                        }
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                mGlobalPreferencesStringSet.add(property);
                                editor.putStringSet("EditPPTPClientSettingsRemoteServerMRU",
                                        mGlobalPreferencesStringSet);
                                applyNewPrefs = true;
                            }
                        }
                        ...
                        if (!Strings.isNullOrEmpty(property)) {
                            ...
                            if (!mGlobalPreferencesStringSet.contains(property)) {
                                mGlobalPreferencesStringSet.add(property);
                                editor.putStringSet("EditPPTPClientSettingsRemoteServerUsername",
                                        mGlobalPreferencesStringSet);
                                applyNewPrefs = true;
                            }
                        }
    ...
    private void updateTileDisplayData(@NonNull final NVRAMInfo data,
        ...
        //Subnet
        property = data
                .getProperty(NVRAMInfo.Companion.getPPTPD_CLIENT_SRVSUB(), defaultValuesIfNotFound ? N_A : null);
        if (property != null) {
        ...
        //MPPE Encyption
        property = data
                .getProperty(NVRAMInfo.Companion.getPPTPD_CLIENT_SRVSEC(), defaultValuesIfNotFound ? N_A : null);
        if (property != null) {
        ...
        //MTU
        property = data
                .getProperty(NVRAMInfo.Companion.getPPTPD_CLIENT_SRVMTU(), defaultValuesIfNotFound ? N_A : null);
        if (property != null) {
        ...
        //MRU
        property = data
                .getProperty(NVRAMInfo.Companion.getPPTPD_CLIENT_SRVMRU(), defaultValuesIfNotFound ? N_A : null);
        if (property != null) {
        ...
        //Username
        property = data
                .getProperty(NVRAMInfo.Companion.getPPTPD_CLIENT_SRVUSER(), defaultValuesIfNotFound ? N_A : null);
        if (property != null) {
