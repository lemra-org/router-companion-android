...
public class WifiSharingActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (primaryColor != null) {
      ...
      tabLayout.setBackgroundColor(
          ContextCompat.getColor(
              this, themeLight ? R.color.lightTheme_primary : R.color.darkTheme_primary));
    }
    ...
    //        tabLayout.setTabTextColors(ContextCompat.getColorStateList(this,
    ...
    writeTagDialog =
        new WriteWifiConfigToNfcDialog(
            this, mSsid, Strings.nullToEmpty(mWifiPassword), mWifiEncType);
