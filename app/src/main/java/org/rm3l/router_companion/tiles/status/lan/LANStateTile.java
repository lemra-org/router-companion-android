...
public class LANStateTile extends DDWRTTile<NVRAMInfo> {
  ...
  public LANStateTile(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
      @Nullable Router router) {
    super(parentFragment, arguments, router, R.layout.tile_status_lan_status, null);
  }
  ...
  @Override public void onLoadFinished(@NonNull Loader<NVRAMInfo> loader,
    ...
    try {
      ...
      layout.findViewById(R.id.tile_status_lan_status_loading_view).setVisibility(View.GONE);
      layout.findViewById(R.id.tile_status_lan_status_gridLayout).setVisibility(View.VISIBLE);
