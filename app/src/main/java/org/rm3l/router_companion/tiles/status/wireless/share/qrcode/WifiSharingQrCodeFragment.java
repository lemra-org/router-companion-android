            ...
            if (PermissionChecker.checkSelfPermission(
                  ...
                  new File(
                      ...
                      Utils.getEscapedFileName(
                              String.format(
                                  ...
                                  nullToEmpty(mSsid), nullToEmpty(wifiSharingData.mRouterUuid)))
                          + ".png");
              OutputStream outputStream = null;
              try {
                outputStream = new BufferedOutputStream(new FileOutputStream(mFileToShare, false));
                mBitmapToExport.compress(
                    Bitmap.CompressFormat.PNG, COMPRESSION_QUALITY, outputStream);
                outputStream.flush();
              } catch (IOException e) {
                e.printStackTrace();
                Utils.displayMessage(
                    activity, getString(R.string.internal_error_please_try_again), Style.ALERT);
                return;
              } finally {
                try {
              ...
              final Uri uriForFile =
                  FileProvider.getUriForFile(
                      activity, RouterCompanionAppConstants.FILEPROVIDER_AUTHORITY, mFileToShare);
                      ...
                      String.format(
                              ...
                              ((TextView)
                                      rootView.findViewById(
                                          R.id.tile_status_wireless_iface_qrcode_note))
                                  .getText(),
