...
public class WANTrafficTileOpenWrt extends WANTrafficTile {
    ...
    public WANTrafficTileOpenWrt(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
        ...
        return new AsyncTaskLoader<NVRAMInfo>(this.mParentFragmentActivity) {
            ...
            public NVRAMInfo loadInBackground() {
                ...
                try {
                    ...
                    nvRamInfoFromRouter.setProperty(wanIface + "_xmit_compressed",
                            netDevWanIfaceList.get(15));
