...
//                            android.R.color.white));
        ...
        new AsyncTask<String, Void, Void>() {
            ...
            protected Void doInBackground(String... params) {
                try {
                    final IPWhoisInfo ipWhoisInfo = ActiveIPConnectionsDetailActivity
                            .mIPWhoisInfoCache
                            .get(publicIpToGeolocate);
                    if (ipWhoisInfo == null) {
                        throw new
                                DDWRTCompanionException("Unable to geo-locate IP Address - please try again later.");
                    }
            ...
            case RouterCompanionAppConstants.Permissions.STORAGE: {
                ...
                if (grantResults.length > 0
                    ...
                    Utils.displayMessage(this,
                            "Will be unable to display (and cache) map!",
                            Style.INFO);
                }
                return;
            }
