...
public class ActiveIPConnectionsStatsAdapter
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final Context context, View itemView) {
            ...
            this.stats6OtherPercentValue = (TextView) this.stats6Other.findViewById(
                    R.id.activity_ip_connections_stats_6_other_percent);
            this.stats6OtherText =
                    (TextView) this.stats6Other.findViewById(R.id.activity_ip_connections_stats_6_other_text);
            this.stats6OtherProgressBar = (ProgressBar) this.stats6Other.findViewById(
                    R.id.activity_ip_connections_stats_6_other_progressbar);
        }
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final Map<String, Integer> statsAt =
                (newPosition >= 0 && newPosition < statsTable.rowKeySet().size()) ? statsTable.row(
                        newPosition) : null;
        switch (newPosition) {
            case BY_SOURCE:
        ...
        holder.shareImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final File file = new File(activity.getCacheDir(), Utils.getEscapedFileName(
                        String.format("IP Connections Stats By %s", holder.title.getText())) + ".png");
                ...
                final Uri uriForFile =
                        FileProvider.getUriForFile(activity, RouterCompanionAppConstants.FILEPROVIDER_AUTHORITY,
                                file);
