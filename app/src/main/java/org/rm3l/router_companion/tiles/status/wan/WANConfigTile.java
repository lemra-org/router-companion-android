...
public class WANConfigTile extends DDWRTTile<NVRAMInfo>
    ...
    public WANConfigTile(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
                            ...
                            try {
                                ...
                                if (isDemoRouter(mRouter)) {
                                    ...
                                    if (nbRunsLoaderModulo == 0) {
                                        ...
                                        nvramInfo.setProperty(REVERSE_DNS_PTR, p2 + "." + p1 + ".64.52.in-addr.arpa");
                                    ...
                                    final String wanPublicIpAddress = RouterFirmwareConnectorManager
                                            .getConnector(mRouter)
                                    ...
                                    if (wanPublicIpCmdStatus.length == 0) {
                                        ...
                                        if (Patterns.IP_ADDRESS.matcher(wanPublicIp).matches()) {
                                            ...
                                            PublicIPChangesServiceTask.Companion
                                                    .buildNotificationIfNeeded(mParentFragmentActivity,
                                                            mRouter, wanPublicIpCmdStatus,
                                                            nvramInfo
                                                                    .getProperty(NVRAMInfo.Companion.getWAN_IPADDR()),
                                                            null);
                                        } else {
                                            nvramInfo.setProperty(INTERNET_CONNECTIVITY_PUBLIC_IP, NOK);
                                        }
                                ...
                                try {
                                    ...
                                    if (revDnsCmdStatus != null && revDnsCmdStatus.length > 0) {
                                        nvramInfo.setProperty(REVERSE_DNS_PTR,
                                                revDnsCmdStatus[revDnsCmdStatus.length - 1]);
                                    }
