...
public class OpenVPNClientTile extends DDWRTTile<NVRAMInfo>
  ...
  private class ManageOpenVpnClientToggle implements View.OnClickListener {
    ...
    public void onClick(View view) {
      ...
      if (!(view instanceof CompoundButton)) {
        ReportingUtils.reportException(
            ...
            new IllegalStateException(
                "ManageOpenVpnClientToggle#onClick: "
      ...
      SnackbarUtils.buildSnackbar(
          ...
          String.format(
              "OpenVPN Client will be %s on '%s' (%s). ",
                        ...
                        new DialogInterface.OnClickListener() {
                          ...
                          public void onClick(DialogInterface dialog, int which) {
                            ...
                            Utils.displayMessage(
                                mParentFragmentActivity,
                                String.format(
                                    "%s OpenVPN Client (and %s PPTP Client) ...",
                        ...
                        new DialogInterface.OnClickListener() {
                          ...
                          public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            Utils.displayMessage(
                                mParentFragmentActivity,
                                String.format(
                                    "%s OpenVPN Client...", enable ? "Enabling" : "Disabling"),
                                Style.INFO);
      ...
      //    String.format("OpenVPN Client will be %s on '%s' (%s). ", enable ? "enabled" :
      // "disabled",
    ...
    try {
      switch (RouterAction.valueOf(routerAction)) {
        case SET_NVRAM_VARIABLES:
          ...
          final String openvpnClEnable =
              nullToEmpty(nvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_ENABLE()));
          ...
          if (mParentFragmentPreferences != null
                    ...
                    new DialogInterface.OnClickListener() {
                      ...
                      public void onClick(DialogInterface dialog, int which) {
                        nvramInfo.setProperty(
                            NVRAMInfo.Companion.getPPTPD_CLIENT_ENABLE(), pptpClientStatusToSet);
                        ActionManager.runTasks(
                            new SetNVRAMVariablesAction(
                                mRouter,
                                mParentFragmentActivity,
            ...
            ActionManager.runTasks(
                new SetNVRAMVariablesAction(
                    mRouter, mParentFragmentActivity, nvramInfo, true, this, mGlobalPreferences));
          }
          break;
        default:
          // Ignored
  ...
  public void onLoadFinished(Loader<NVRAMInfo> loader, NVRAMInfo data) {
    try {
      ...
      layout
          .findViewById(R.id.tile_services_openvpn_client_header_loading_view)
          .setVisibility(View.GONE);
      layout.findViewById(R.id.tile_services_openvpn_client_loading_view).setVisibility(View.GONE);
      layout
          .findViewById(R.id.tile_services_openvpn_client_grid_layout)
      ...
      if (data.getException() == null) {
        final String openvpnClEnabled = data.getProperty(NVRAMInfo.Companion.getOPENVPNCL_ENABLE());
      ...
      final boolean makeToogleEnabled =
          (data != null
              && data.getData() != null
              && data.getData().containsKey(NVRAMInfo.Companion.getOPENVPNCL_ENABLE()));
              ...
              try {
                ...
                nvramInfoTmp =
                    SSHUtils.getNVRamInfoFromRouter(
                        ...
                        NVRAMInfo.Companion.getOPENVPNCL_ADV(),
                        NVRAMInfo.Companion.getOPENVPNCL_TLSCIP(),
                ...
                String property =
                    nvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_REMOTEIP());
  ...
  protected OnClickIntent getOnclickIntent() {
    ...
    return new OnClickIntent(
        "Loading OpenVPN Client Settings...", editOpenVPNClSettingsIntent, this);
  }
  ...
  private void updateTileDisplayData(
    ...
    if (statusKey != null) {
      ...
      ((TextView) layout.findViewById(R.id.tile_services_openvpn_client_state))
          .setText(statusValue);
    }
    ...
    property =
        data.getProperty(
            NVRAMInfo.Companion.getOPENVPNCL_REMOTEPORT(), defaultValuesIfNotFound ? N_A : null);
    if (property != null) {
    ...
    property =
        data.getProperty(
            NVRAMInfo.Companion.getOPENVPNCL_TUNTAP(), defaultValuesIfNotFound ? N_A : null);
    if (property != null) {
    ...
    final String protoProp =
        data.getProperty(
            NVRAMInfo.Companion.getOPENVPNCL_PROTO(), defaultValuesIfNotFound ? N_A : null);
    if (protoProp != null) {
    ...
    final String encCipherProp =
        data.getProperty(
            NVRAMInfo.Companion.getOPENVPNCL_CIPHER(), defaultValuesIfNotFound ? N_A : null);
    ...
    final String hashAlgoProp =
        data.getProperty(
            NVRAMInfo.Companion.getOPENVPNCL_AUTH(), defaultValuesIfNotFound ? N_A : null);
