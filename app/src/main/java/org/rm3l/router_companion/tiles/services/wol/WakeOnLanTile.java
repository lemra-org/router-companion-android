    ...
    public static RouterData<ArrayList<Device>> getArrayListRouterDataSync(
        ...
        try {
            ...
            if (nvRamInfoFromRouter != null) {
                ...
                //Now Wol_Hosts
                property =
                        nvRamInfoFromRouter.getProperty(NVRAMInfo.Companion.getWOL_HOSTS(),
                                RouterCompanionAppConstants.EMPTY_STRING);
                                                        ...
                                                        try {
                                                            switch (RouterAction.valueOf(routerAction)) {
                                                                case WAKE_ON_LAN:
                                                                    ...
                                                                    final AtomicInteger currentNum
                                                                            = new AtomicInteger(0);
                                                                    final AtomicInteger numActionsWithNoSuccess =
                                                                            new AtomicInteger(0);
                                                                    final int totalNumOfDevices = mCurrentDevicesList
                                                                            .size();
                                        ...
                                        new AlertDialog.Builder(mParentFragmentActivity).setIcon(
                                                ...
                                                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(final DialogInterface dialogInterface,
                                                            final int i) {
                                                        if (mParentFragmentPreferences != null) {
                                                            mParentFragmentPreferences.edit().remove(wolHostsPrefKey)
                                                                    .apply();
