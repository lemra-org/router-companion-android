        ...
        try {
          ...
          try {
            ...
            if (uciNetworkInfo != null) {
              ...
              wanUptimeStr =
                  uciNetworkInfo.getProperty(UCIInfo.Companion.getNETWORK_WAN_CONNECT_TIME());
            }
            ...
            final String[] uptimes =
                SSHUtils.getManualProperty(
                    mParentFragmentActivity, mRouter, mGlobalPreferences, "/bin/cat /proc/uptime");
            if (wanUptimeStr != null && uptimes != null && uptimes.length >= 1) {
              ...
              final List<String> sysUptimeSplitList =
                  Splitter.on(" ").trimResults().omitEmptyStrings().splitToList(uptimes[0]);
