...
public class StatusRouterSpaceUsageTile extends DDWRTTile<NVRAMInfo> {
  ...
  public StatusRouterSpaceUsageTile(
  ...
  public void onLoadFinished(@NonNull final Loader<NVRAMInfo> loader, @Nullable NVRAMInfo data) {
    try {
      ...
      layout
          .findViewById(R.id.tile_status_router_router_space_usage_loading_view)
          .setVisibility(View.GONE);
      layout
          .findViewById(R.id.tile_status_router_router_space_usage_gridLayout)
            ...
            if (nvramSizeStr != null && nvramSizeStr.startsWith("size:")) {
              ...
              if (stringList.size() >= 5) {
                ...
                try {
                  ...
                  nvramInfo.setProperty(
                      NVRAMInfo.Companion.getNVRAM_USED_PERCENT(),
