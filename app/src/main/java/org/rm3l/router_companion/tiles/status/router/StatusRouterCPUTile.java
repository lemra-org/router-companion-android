...
public class StatusRouterCPUTile extends DDWRTTile<NVRAMInfo> {
    ...
    public StatusRouterCPUTile(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
                    ...
                    try {
                        ...
                        if (isDemoRouter(mRouter)) {
                            nvramInfoTmp = new NVRAMInfo()
                                    .setProperty(NVRAMInfo.Companion.getCPU_CLOCK_FREQ(), "100");
                        } else {
                        ...
                        if (otherCmds != null) {
                            ...
                            if (otherCmds.length >= 2) {
                                ...
                                if (modelNameLine != null) {
                                    ...
                                    if (!list.isEmpty()) {
                                        nvramInfo.setProperty(NVRAMInfo.Companion.getCPU_MODEL(),
                                                list.iterator().next());
                                    }
                                }
                            }
