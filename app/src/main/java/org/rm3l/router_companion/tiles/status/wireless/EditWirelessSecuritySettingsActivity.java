...
public class EditWirelessSecuritySettingsActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    ((CheckBox) findViewById(
        R.id.wireless_security_settings_wpa2_personal_mixed_wpa_key_show_checkbox)).setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (!isChecked) {
    ...
    ((CheckBox) findViewById(
        R.id.wireless_security_settings_wpa_enterprise_radius_secret_show_checkbox)).setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (!isChecked) {
    ...
    ((CheckBox) findViewById(
        R.id.wireless_security_settings_wpa2_enterprise_radius_secret_show_checkbox)).setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (!isChecked) {
    ...
    ((CheckBox) findViewById(
        R.id.wireless_security_settings_wpa2_enterprise_mixed_radius_secret_show_checkbox)).setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (!isChecked) {
    ...
    wepKeyGenerateButton.setOnClickListener(new View.OnClickListener() {
      ...
      @NonNull private String wep128Passphase(@NonNull final String passphrase)
      ...
      @NonNull private String padto64(@Nullable String val) {
    ...
    switch (securityModeSelectedItemPosition) {
        ...
        //WPA Personal
      {
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa_personal_wpa_algorithms)).getSelectedItemPosition());
        ...
        //WPA Enterprise
      {
        ...
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa_enterprise_wpa_algorithms)).getSelectedItemPosition());
        final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
        if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
          nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
        }
        ...
        //WPA2 Personal
      {
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa2_personal_wpa_algorithms)).getSelectedItemPosition());
        final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
        if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
          nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
        }
        ...
        //WPA2 Enterprise
      {
        ...
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa2_enterprise_wpa_algorithms)).getSelectedItemPosition());
        final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
        if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
          nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
        }
        ...
        //WPA2 Personal Mixed
      {
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa2_personal_mixed_wpa_algorithms)).getSelectedItemPosition());
        final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
        if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
          nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
        }
        ...
        //WPA2 Enterprise Mixed
      {
        ...
        final String wpaAlgoSelectedItem = wpaAlgoValues.inverse()
            .get(((Spinner) findViewById(
                R.id.wireless_security_settings_wpa2_enterprise_mixed_wpa_algorithms)).getSelectedItemPosition());
        final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
        if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
          nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
        }
