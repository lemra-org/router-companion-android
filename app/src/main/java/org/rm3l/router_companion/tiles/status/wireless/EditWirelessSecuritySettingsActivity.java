...
public class EditWirelessSecuritySettingsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mPhyIface =
        mNvramInfo.getProperty(
            WirelessIfaceTile.IFACE, RouterCompanionAppConstants.EMPTY_VALUE_TO_DISPLAY);

    mParentIface = mNvramInfo.getProperty(WirelessIfaceTile.PARENT_IFACE);

    mSsid =
        mNvramInfo.getProperty(
            WifiSharingActivity.SSID, RouterCompanionAppConstants.EMPTY_VALUE_TO_DISPLAY);
    ...
    ((CheckBox)
            findViewById(R.id.wireless_security_settings_wpa2_personal_mixed_wpa_key_show_checkbox))
        .setOnCheckedChangeListener(
            new CompoundButton.OnCheckedChangeListener() {
              @Override
              public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                wpa2PersMixedSharedKeyEditText.setSelection(
                    wpa2PersMixedSharedKeyEditText.length());
              }
            });
    ...
    final EditText wpa2EnterpriseMixedRadiusSecretEditText =
        (EditText)
            findViewById(R.id.wireless_security_settings_wpa2_enterprise_mixed_radius_secret);
    ((CheckBox)
            findViewById(
    ...
    wepKeyGenerateButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            // cf.
            // https://github.com/crockpotveggies/VeggieRecipies/blob/master/VeggieRecipies/src/it/evilsocket/dsploit/wifi/algorithms/OnoKeygen.java
            ...
            if (wepBitStr == null || wepBitStr.isEmpty()) {
              Toast.makeText(
                      EditWirelessSecuritySettingsActivity.this,
    ...
    wepPassphraseEditText.addTextChangedListener(
        new TextWatcher() {
          @Override
  ...
  public void finish() {
    ...
    final int securityModeSelectedItemPosition =
        ((Spinner) findViewById(R.id.wireless_security_settings_security_mode))
            .getSelectedItemPosition();
    ...
    if (securityModeSelectedItem != null
        && !securityModeSelectedItem.equals(
            mNvramInfo.getProperty(
                this.mPhyIface + "_security_mode",
      ...
      if (props.containsKey(this.mPhyIface + "_security_mode")) {
        ...
        nvramVarsToUpdate.setProperty(this.mPhyIface.replace(".", "X"), securityModeSelectedItem);
      }
    }
    switch (securityModeSelectedItemPosition) {
      ...
      case 1:
        // WPA Personal
        {
          final String wpaAlgoSelectedItem =
              wpaAlgoValues
                  .inverse()
                  .get(
                      ((Spinner)
          ...
          //                final String wlUnmask = ((CheckBox)
          // findViewById(R.id.wireless_security_settings_wpa_personal_wpa_key_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!wlUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_wl_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_wl_unmask",
          // wlUnmask);
          //                }
      ...
      case 2:
        // WPA Enterprise
        {
          ...
          if (!isNullOrEmpty(radiusAuthServer)) {
            if (!Patterns.IP_ADDRESS.matcher(radiusAuthServer).matches()) {
              Utils.displayMessage(
                  this, "Invalid Radius IP Address: " + radiusAuthServer, Style.ALERT);
              return;
            }
          }
          ...
          final String wpaKeyRenewalInterval =
              ((EditText)
                      findViewById(R.id.wireless_security_settings_wpa_enterprise_key_renewal_port))
                  .getText()
                  .toString();
          if (!wpaKeyRenewalInterval.equals(
              mNvramInfo.getProperty(this.mPhyIface + "_wpa_gtk_rekey"))) {
          ...
          //                final String radiusUnmask = ((CheckBox)
          // findViewById(R.id.wireless_security_settings_wpa_enterprise_radius_secret_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!radiusUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_radius_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_radius_unmask",
          // radiusUnmask);
          //                }
      ...
      case 3:
        // WPA2 Personal
        {
          ...
          //                final String wlUnmask = ((CheckBox)
          // findViewById(R.id.wireless_security_settings_wpa2_personal_wpa_key_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!wlUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_wl_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_wl_unmask",
      ...
      case 4:
        // WPA2 Enterprise
        {
          ...
          final String wpaKeyRenewalInterval =
              ((EditText)
                      findViewById(
                          R.id.wireless_security_settings_wpa2_enterprise_key_renewal_port))
                  .getText()
                  .toString();
          if (!wpaKeyRenewalInterval.equals(
              mNvramInfo.getProperty(this.mPhyIface + "_wpa_gtk_rekey"))) {
          ...
          //                final String radiusUnmask = ((CheckBox)
          // findViewById(R.id.wireless_security_settings_wpa2_enterprise_radius_secret_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!radiusUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_radius_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_radius_unmask",
      ...
      case 5:
        // WPA2 Personal Mixed
        {
              ...
              wpaAlgoValues
                  ...
                  .get(
                      ((Spinner)
                              findViewById(
                                  R.id
                                      .wireless_security_settings_wpa2_personal_mixed_wpa_algorithms))
                          .getSelectedItemPosition());
          final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
          if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
            nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
          ...
          final String wpaKeyRenewalInterval =
              ((EditText)
                      findViewById(R.id.wireless_security_settings_wpa2_personal_mixed_key_renewal))
                  .getText()
                  .toString();
          if (!wpaKeyRenewalInterval.equals(
              mNvramInfo.getProperty(this.mPhyIface + "_wpa_gtk_rekey"))) {
      ...
      case 6:
        // WPA2 Enterprise Mixed
        {
          ...
          final String radiusAuthServer =
              ((EditText)
                      findViewById(R.id.wireless_security_settings_wpa2_enterprise_mixed_radius_ip))
                  .getText()
                  .toString();
          if (!isNullOrEmpty(radiusAuthServer)) {
            if (!Patterns.IP_ADDRESS.matcher(radiusAuthServer).matches()) {
              ...
              wpaAlgoValues
                  ...
                  .get(
                      ((Spinner)
                              findViewById(
                                  R.id
                                      .wireless_security_settings_wpa2_enterprise_mixed_wpa_algorithms))
                          .getSelectedItemPosition());
          final String wpaAlgoFromStart = mNvramInfo.getProperty(this.mPhyIface + "_crypto");
          if (wpaAlgoSelectedItem != null && !wpaAlgoSelectedItem.equals(wpaAlgoFromStart)) {
            nvramVarsToUpdate.setProperty(this.mPhyIface + "_crypto", wpaAlgoSelectedItem);
          ...
          final String wpaKeyRenewalInterval =
              ((EditText)
                      findViewById(
                          R.id.wireless_security_settings_wpa2_enterprise_mixed_key_renewal_port))
                  .getText()
                  .toString();
          if (!wpaKeyRenewalInterval.equals(
              mNvramInfo.getProperty(this.mPhyIface + "_wpa_gtk_rekey"))) {
          ...
          final String radiusPort =
              ((EditText)
                      findViewById(
                          R.id.wireless_security_settings_wpa2_enterprise_mixed_radius_port))
                  .getText()
                  .toString();
          if (!radiusPort.equals(mNvramInfo.getProperty(this.mPhyIface + "_radius_port"))) {
            nvramVarsToUpdate.setProperty(this.mPhyIface + "_radius_port", radiusPort);
          ...
          //                        ((CheckBox)
          // findViewById(R.id.wireless_security_settings_wpa2_enterprise_mixed_radius_secret_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!radiusUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_radius_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_radius_unmask",
      ...
      case 7:
        // Radius
        {
          ...
          //                final String radiusUnmask = ((CheckBox)
          // findViewById(R.id.wireless_security_settings_radius_secret_show_checkbox))
          //                        .isChecked() ? "1" : "0";
          //                if (!radiusUnmask.equals(mNvramInfo.getProperty(this.mPhyIface +
          // "_radius_unmask"))) {
          //                    nvramVarsToUpdate.setProperty(this.mPhyIface + "_radius_unmask",
      ...
      case 8:
        // WEP
        {
          ...
          } else if (transmitKeyRadioGroup
              == R.id.wireless_security_settings_wep_default_transmit_key_2) {
            transmitKeySelectedItem = "2";

          } else if (transmitKeyRadioGroup
              == R.id.wireless_security_settings_wep_default_transmit_key_3) {
            transmitKeySelectedItem = "3";

          } else if (transmitKeyRadioGroup
              == R.id.wireless_security_settings_wep_default_transmit_key_4) {
          ...
          final String wepEncryptionSelectedItem =
              wepEncryptionValues
                  .inverse()
                  .get(
                      ((Spinner) findViewById(R.id.wireless_security_settings_wep_encryption))
          ...
          if (wepEncryptionSelectedItem != null
              && !wepEncryptionSelectedItem.equals(
  ...
  private void fillForm() {
    ...
    if (!securityModeValues.containsKey(securityMode)) {
      Utils.reportException(
          null, new IllegalStateException("Unknown securityMode: " + securityMode));
    }
    ...
    if (!isNullOrEmpty(wpaKeyRenewalInterval)) {
      ...
      ((EditText) findViewById(R.id.wireless_security_settings_wpa2_personal_mixed_key_renewal))
          .setText(wpaKeyRenewalInterval, EDITABLE);
      ((EditText)
              findViewById(R.id.wireless_security_settings_wpa2_enterprise_mixed_key_renewal_port))
          .setText(wpaKeyRenewalInterval, EDITABLE);
    }
    ...
    if (!radiusMacFormatValues.containsKey(radiusMacFormat)) {
      Utils.reportException(
          null, new IllegalStateException("Unknown radiusMacFormat: " + radiusMacFormat));
    }
    position = (position != null ? position : 0);
    ((Spinner) findViewById(R.id.wireless_security_settings_radius_mac_format))
        .setSelection(position);
    ...
    if (!isNullOrEmpty(wepTransmitKey)) {
      switch (wepTransmitKey) {
        ...
        default:
          Utils.reportException(
              null, new IllegalStateException("Unknown wepTransmitKey: " + wepTransmitKey));
          break;
      }
    }
    ...
    if (!wepEncryptionValues.containsKey(wepEncryption)) {
      ...
      Utils.reportException(
          null, new IllegalStateException("Unknown wepEncryption: " + wepEncryption));
    }
    position = (position != null ? position : 0);
  ...
  private void showDetailedViewAt(final int position) {
    ...
    for (int i = 0; i < mDetailedViews.length; i++) {
      ...
      FirebaseCrashlytics.getInstance()
          .log("<i,detailedViewId>=<" + i + "," + detailedViewId + ">");
