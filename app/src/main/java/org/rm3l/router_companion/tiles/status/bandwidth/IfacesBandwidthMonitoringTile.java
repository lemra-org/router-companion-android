...
public class IfacesBandwidthMonitoringTile extends DDWRTTile<None> {
  ...
  @NonNull
  private final Map<String, BandwidthMonitoringTile.BandwidthMonitoringIfaceData>
  ...
  public IfacesBandwidthMonitoringTile(
  ...
  public void onLoadFinished(Loader<None> loader, None data) {
    ...
    try {
      ...
      layout
          .findViewById(R.id.tile_status_bandwidth_monitoring_graph_loading_view)
            ...
            new View.OnClickListener() {
              ...
              public void onClick(View v) {
                ...
                for (final String iface : new TreeSet<>(nvRamInfoFromRouterPerIface.keySet())) {
                  ...
                  menu.add(
                      R.id.tile_status_bandwidth_iface_selection,
                      ifaceMenuItemId,
                      orderIdx++,
                      iface);
                }
                ...
                final MenuItem rtMenuItem =
                    menu.findItem(R.id.tile_status_bandwidth_realtime_graphs);
                if (mParentFragmentPreferences != null) {
                          ...
                          if (rtGraphsEnabled) {
                            ...
                            if (mSupportLoaderManager != null && mCurrentLoader != null) {
                              mSupportLoaderManager.restartLoader(
                                  ...
                                  mFragmentArguments,
                                  IfacesBandwidthMonitoringTile.this);
                            }
                          }
                          if (mParentFragmentPreferences != null) {
  ...
  protected Loader<None> getLoader(int id, Bundle args) {
    this.mCurrentLoader =
        new AsyncTaskLoader<None>(this.mParentFragmentActivity) {
          ...
          public None loadInBackground() {
            ...
            try {
              ...
              if (mRefreshing.getAndSet(true)) {
                return (None)
                    new None().setException(new DDWRTTileAutoRefreshNotAllowedException());
              }
              nbRunsLoader++;
              ...
              //                            final Comparator<BandwidthMonitoringTile.DataPoint>
              // comparator = new Comparator<BandwidthMonitoringTile.DataPoint>() {
              //                                @Override
              //                                public int compare(BandwidthMonitoringTile.DataPoint
              // lhs, BandwidthMonitoringTile.DataPoint rhs) {
              //                                    if (lhs == rhs) {
              //                                        return 0;
              //                                    }
              //                                    if (rhs == null) {
              ...
              //                                    final
              // SortedSet<BandwidthMonitoringTile.DataPoint> dataPoints = new
              // TreeSet<>(comparator);
              ...
              //                                    }
              //                                    for (final BandwidthMonitoringTile.DataPoint
              ...
              //                                }
              //
              //                                bandwidthMonitoringIfaceDataMap.put(key,
              // bandwidthMonitoringIfaceData);
              //                            }
              //                        }
              //
                ...
                mIfacePreviouslySelectedForDisplay.set(
                    (mParentFragmentPreferences != null
                        ? mParentFragmentPreferences.getString(
                            getFormattedPrefKey(IFACE_DISPLAYED), null)
                        : null));
              }
                  ...
                  if (ifacePreviouslySelectedForDisplay == null && iface.equals(wanIface.trim())) {
                    ...
                    if (mParentFragmentPreferences != null) {
                      mParentFragmentPreferences
                          .edit()
                          .putString(
                              getFormattedPrefKey(IFACE_DISPLAYED),
              ...
              try {
                ...
                for (Map.Entry<String, BandwidthMonitoringTile.BandwidthMonitoringIfaceData> entry :
                    bandwidthMonitoringIfaceDataMap.entrySet()) {
          ...
          private boolean fetchBandwidthDataForIface(final String iface) throws Exception {
            ...
            if (bandwidthMonitoringIfaceData == null) {
              bandwidthMonitoringIfaceDataMap.put(
                  iface, new BandwidthMonitoringTile.BandwidthMonitoringIfaceData());
            }
            bandwidthMonitoringIfaceData = bandwidthMonitoringIfaceDataMap.get(iface);

            @SuppressWarnings("MalformedFormatString")
            final String[] netDevDataForIface =
                SSHUtils.getManualProperty(
                    mParentFragmentActivity,
                    mRouter,
                    mGlobalPreferences,
            ...
            try {
              wanRcvBytes =
                  (Double.parseDouble(nvramInfo.getProperty(iface + "_rcv_bytes_t1", "-255"))
                      - Double.parseDouble(nvramInfo.getProperty(iface + "_rcv_bytes", "-1")));
              if (wanRcvBytes >= 0.) {
                bandwidthMonitoringIfaceData.addData(
                    "IN", new BandwidthMonitoringTile.DataPoint(timestamp, wanRcvBytes));
              }
            ...
            nvramInfo.setProperty(
                ...
                org.rm3l.router_companion.utils.FileUtils.byteCountToDisplaySize(
                        Double.valueOf(wanRcvBytes).longValue())
                    + "ps");
            ...
            try {
              ...
              if (wanXmitBytes >= 0.) {
                bandwidthMonitoringIfaceData.addData(
                    "OUT", new BandwidthMonitoringTile.DataPoint(timestamp, wanXmitBytes));
              }
            } catch (@NonNull final NumberFormatException nfe) {
              return false;
            }
            ...
            nvramInfo.setProperty(
                iface + "_egress_MB",
                org.rm3l.router_companion.utils.FileUtils.byteCountToDisplaySize(
                        Double.valueOf(wanXmitBytes).longValue())
                    + "ps");
