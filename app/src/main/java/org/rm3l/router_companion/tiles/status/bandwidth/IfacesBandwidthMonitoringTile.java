...
//                    }
                        ...
                        mIfacePreviouslySelectedForDisplay.set(
                                (mParentFragmentPreferences != null ?
                                        mParentFragmentPreferences
                                                .getString(getFormattedPrefKey(IFACE_DISPLAYED), null) : null));
                    }
                    ...
                    final String[] allMonitoredIfaces = SSHUtils.getManualProperty(mParentFragmentActivity, mRouter, mGlobalPreferences,
    ...
    private void displayGraphForIface(String ifaceStr) {
        ...
        ((TextView) this.layout.findViewById(R.id.tile_status_bandwidth_monitoring_title))
                .setText(this.mParentFragmentActivity.getResources()
                        .getString(R.string.bandwidth_usage_mb) + (!Strings.isNullOrEmpty(ifaceStr) ?
                        (": " + ifaceStr) : ""));
