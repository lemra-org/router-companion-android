...
public class AvocarrotNativeAdTile extends DDWRTTile<Void> {
  ...
  public AvocarrotNativeAdTile(@NonNull Fragment parentFragment, @NonNull Bundle arguments,
  ...
  @Override public void onLoadFinished(final Loader<Void> loader, Void data) {
    final com.avocarrot.androidsdk.AvocarrotCustom avocarrotCustom =
        new com.avocarrot.androidsdk.AvocarrotCustom(mParentFragmentActivity,
    ...
    avocarrotCustom.setListener(new com.avocarrot.androidsdk.AvocarrotCustomListener() {
      ...
      @Override public void onAdError(AdError error) {
        try {
          super.onAdError(error);
          ReportingUtils.reportException(null, new AdUtils.AdFailedToShowEvent(
              "Avocarrot: " + (error != null ? error.toString() : "")));
      ...
      @Override public void onAdLoaded(List<CustomModel> ads) {
        ...
        try {
          ...
          final TextView description =
              (TextView) layout.findViewById(R.id.tile_native_ad_description);
          final ImageView imageIconView =
              (ImageView) layout.findViewById(R.id.tile_native_ad_image_view);
          final ImageView ratingImageView =
              (ImageView) layout.findViewById(R.id.tile_native_ad_rating_image_view);
          ...
          Utils.downloadImageFromUrl(mParentFragmentActivity, ad.getRatingImageUrl(),
              ratingImageView, null, null, new Callback() {
