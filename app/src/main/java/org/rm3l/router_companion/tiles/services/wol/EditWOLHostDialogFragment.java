...
public class EditWOLHostDialogFragment extends AddWOLHostDialogFragment {
  ...
  @Override public void onStart() {
    ...
    if (d != null) {
      ...
      ((EditText) d.findViewById(R.id.wol_host_add_name)).setText(mDeviceToEdit.getName(),
          TextView.BufferType.EDITABLE);
      ((EditText) d.findViewById(R.id.wol_host_add_mac_addr)).setText(mDeviceToEdit.getMacAddress(),
          TextView.BufferType.EDITABLE);
  ...
  @NonNull @Override protected RouterActionListener getRouterActionListener() {
    return new RouterActionListener() {
      ...
      public void onRouterActionSuccess(@NonNull RouterAction routerAction, @NonNull Router router,
        ...
        try {
          ...
          try {
            mDeviceToEdit.setWolPort(Integer.parseInt(
