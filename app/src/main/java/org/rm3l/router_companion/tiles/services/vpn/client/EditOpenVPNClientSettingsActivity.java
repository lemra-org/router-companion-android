...
public class EditOpenVPNClientSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CheckBox) findViewById(
                R.id.openvpn_client_settings_advanced_options_flag)).setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        findViewById(R.id.openvpn_client_settings_advanced_options).setVisibility(
        ...
        //NAT
        ((CheckBox) findViewById(
                R.id.openvpn_client_settings_advanced_options_nat)).setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            findViewById(
                                    ...
                                    .setVisibility(
                                            View.GONE);
                            findViewById(
                                    R.id.openvpn_client_settings_advanced_options_nat_firewall).setVisibility(
                                    View.VISIBLE);
                        } else {
                            findViewById(
                                    R.id.openvpn_client_settings_advanced_options_nat_bridge_tap_to_br0)
    ...
    public void finish() {
        ...
        final String tunnelDeviceSelectedItem = tunnelDeviceSpinnerValues.inverse()
    ...
    private void fillForm() {
        ...
        final Set<String> editOpenVPNClientSettingsTargetServers = sharedPreferences.getStringSet(
        ...
        serverIpOrNameAutoComplete
                .setText(mNvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_REMOTEIP()), EDITABLE);
        ...
        final Set<String> editOpenVPNClientSettingsServerPorts =
                sharedPreferences.getStringSet(EDIT_OPEN_VPN_CLIENT_SETTINGS_SERVER_PORTS_AUTOCOMPLETE_PREF,
                        new HashSet<String>());
        ...
        serverPortAutoComplete
                .setText(mNvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_REMOTEPORT()), EDITABLE);
        ...
        position =
                lzoCompression != null ? lzoCompressionSpinnerValues.get(lzoCompression.toLowerCase())
                        : null;
        ((Spinner) findViewById(R.id.openvpn_client_settings_lzo_compression)).setSelection(
        ...
        final Set<String> editOpenVPNClientSettingsLocalIPs =
                sharedPreferences.getStringSet(EDIT_OPEN_VPN_CLIENT_SETTINGS_LOCAL_IPS_AUTOCOMPLETE_PREF,
                        new HashSet<String>());
        ...
        final Set<String> editOpenVPNClientSettingsLocalSubnets = sharedPreferences.getStringSet(
        ...
        final Set<String> editOpenVPNClientSettingsMTUSettings =
                sharedPreferences.getStringSet(EDIT_OPEN_VPN_CLIENT_SETTINGS_MTU_SETTINGS_AUTOCOMPLETE_PREF,
                        new HashSet<String>());
        ...
        mtuSettingAutoCompleteView
                .setText(mNvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_MTU(), "1400"), EDITABLE);
        ...
        final Set<String> editOpenVPNClientSettingsUDPFragment = sharedPreferences.getStringSet(
        ...
        udpFragmentAutoCompleteView
                .setText(mNvramInfo.getProperty(NVRAMInfo.Companion.getOPENVPNCL_FRAGMENT()), EDITABLE);
