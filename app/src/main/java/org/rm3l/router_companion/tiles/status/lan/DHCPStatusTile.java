        ...
        try {
          ...
          try {
            ...
            if (Utils.isDemoRouter(mRouter)) {
              nvramInfoTmp =
                  new NVRAMInfo()
                      .setProperty(NVRAMInfo.Companion.getLAN_PROTO(), "dhcp")
              ...
              nvramInfoTmp =
                  SSHUtils.getNVRamInfoFromRouter(
                      ...
                      mRouter,
                      mGlobalPreferences,
                      NVRAMInfo.Companion.getLAN_PROTO(),
                      NVRAMInfo.Companion.getDHCP_DNSMASQ(),
                      NVRAMInfo.Companion.getDHCP_START(),
                      NVRAMInfo.Companion.getDHCP_NUM(),
                      NVRAMInfo.Companion.getDHCP_LEASE(),
                      NVRAMInfo.Companion.getLAN_IPADDR(),
                      NVRAMInfo.Companion.getLAN_NETMASK());
            }
            ...
            final String dhcpHostCountStr =
                nvramInfo.getProperty(NVRAMInfo.Companion.getDHCP_NUM());
                    ...
                    if (allAddresses != null) {
                      ...
                      if (allAddresses.length >= distFromLowIpToStartIp + dhcpHostCount) {
                        nvramInfo.setProperty(
                            DHCP_END_IP, allAddresses[distFromLowIpToStartIp + dhcpHostCount - 1]);
                      }
                    }
