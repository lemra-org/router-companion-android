...
public class WANAccessPolicy {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (denyOrFilter != null ? !denyOrFilter.equals(that.denyOrFilter)
        : that.denyOrFilter != null) {
      return false;
    }
    if (blockedServices != null ? !blockedServices.equals(that.blockedServices)
        : that.blockedServices != null) {
      return false;
    }
    if (blockedWebsitesByUrl != null ? !blockedWebsitesByUrl.equals(that.blockedWebsitesByUrl)
        : that.blockedWebsitesByUrl != null) {
      return false;
    }
    return blockedWebsitesByKeyword != null ? blockedWebsitesByKeyword.equals(
        that.blockedWebsitesByKeyword) : that.blockedWebsitesByKeyword == null;
  }
  ...
  @Override public int hashCode() {
    ...
    result =
        31 * result + (blockedWebsitesByKeyword != null ? blockedWebsitesByKeyword.hashCode() : 0);
    return result;
  }
  ...
  @Override public String toString() {
    return "WANAccessPolicy{"
        ...
        + ", blockedServices="
        + blockedServices
        + ", blockedWebsitesByUrl="
        + blockedWebsitesByUrl
        + ", blockedWebsitesByKeyword="
        + blockedWebsitesByKeyword
        + '}';
  }
}
