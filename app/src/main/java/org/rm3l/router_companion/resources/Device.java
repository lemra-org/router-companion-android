...
public class Device implements Comparable<Device> {
   ...
   * @return this object
   */
  @NonNull public Device setAlias(@Nullable final String alias) {
    this.alias = alias;
    return this;
  }
   ...
   * @return this object
   */
  @NonNull public Device setIpAddress(@Nullable final String ipAddress) {
   ...
   */
  @Nullable public String getSystemName() {
    return systemName;
  }

  @NonNull public Device setSystemName(@Nullable final String systemName) {
    this.systemName = systemName;
    return this;
  }

  @Nullable public WirelessConnectionInfo getWirelessConnectionInfo() {
  ...
  @Override public int compareTo(@NonNull final Device device) {
  ...
  @SuppressWarnings("ConstantConditions") @NonNull public String getName() {
  ...
  @NonNull public String getAliasOrSystemName() {
    if (!isNullOrEmpty(this.alias)) {
      return this.alias;
    }
  ...
  @Nullable public MACOUIVendor getMacouiVendorDetails() {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (!macAddress.equals(device.macAddress)) return false;
  ...
  @NonNull public WANAccessState getWanAccessState() {
  ...
  @Nullable public Set<String> getActiveIpConnections() {
  ...
  public static class WirelessConnectionInfo {
    ...
    @Nullable public String getSnrMargin() {
      return snrMargin;
    }
    ...
    @Nullable public String getRssi() {
      return rssi;
    }
