...
public class SpeedTestResult {
  ...
  @NonNull private Number wanPing;

  @NonNull private Number wanDl;

  @NonNull private Number wanUl;

  /**
   * Useless ?
   */
  @Nullable private String connectionType;

  @Nullable private Number connectionDl;

  @Nullable private Number connectionUl;

  @NonNull private String server;

  @Nullable private String serverCountryCode;
  ...
  public SpeedTestResult(@NonNull String router, @NonNull String date, @NonNull String server,
      @NonNull Number wanPing, @NonNull Number wanDl, @NonNull Number wanUl,
      @Nullable String connectionType, @Nullable Number connectionDl, @Nullable Number connectionUl,
    ...
    this.wanPingRTT = new PingRTT().setAvg(wanPing.floatValue());
  }
  ...
  @Nullable public String getServerCountryCode() {
  ...
  @NonNull public Number getWanPing() {
    return wanPing;
  }
  ...
  @NonNull public Number getWanDl() {
    return wanDl;
  }
  ...
  @NonNull public Number getWanUl() {
    return wanUl;
  }
  ...
  @Nullable public String getConnectionType() {
  ...
  @Nullable public Number getConnectionDl() {
    return connectionDl;
  }
  ...
  @Nullable public Number getConnectionUl() {
    return connectionUl;
  }
