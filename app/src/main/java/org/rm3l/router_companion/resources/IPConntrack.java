...
public class IPConntrack {
  ...
  @Nullable private String rawLine;

  /**
   * Protocol name and number
   */
  @Nullable private String transportProtocol;

  @Nullable private String sourceHostname;

  @Nullable private String destWhoisOrHostname;
   ...
   */
  @Nullable private String tcpConnectionState;

  /**
   * Source address of “original”-side packets (packets from the side
   * that initiated the connection).
   */
  @Nullable private String sourceAddressOriginalSide;

  /**
   * Destination address of original-side packets.
   */
  @Nullable private String destinationAddressOriginalSide;
   ...
   */
  @Nullable private String sourceAddressReplySide;

  /**
   * Destination address of reply-side packets.
   */
  @Nullable private String destinationAddressReplySide;
  ...
  @Nullable private String icmpId;

  @Nullable private int icmpType;

  @Nullable private int icmpCode;

  @Nullable public static IPConntrack parseIpConntrackRow(@NonNull final String raw) {
    ...
    try {
          ...
          if (toList.size() >= 5) {
            for (int i = 4; i < toList.size(); i++) {
              ...
              if (stringList != null && stringList.size() >= 2) {
                ...
                } else if (ipConntrack.getPackets() <= 0l && "packets".equalsIgnoreCase(
                    firstPart)) {
                  ipConntrack.setPackets(Long.parseLong(secondPart));
                } else if (ipConntrack.getBytes() <= 0l && "bytes".equalsIgnoreCase(firstPart)) {
                  ipConntrack.setBytes(Long.parseLong(secondPart));
                } else if (ipConntrack.getStructUseCount() <= 0 && "use".equalsIgnoreCase(
                    firstPart)) {
              ...
              if (stringList != null && stringList.size() >= 2) {
                ...
                if ("src".equalsIgnoreCase(firstPart)) {
                  ...
                  ipConntrack.setBytes(Long.parseLong(secondPart));
                    ...
                    firstPart)) {
                  ipConntrack.setStructUseCount(Integer.parseInt(secondPart));
                } else if (ipConntrack.getIcmpId() == null && "id".equalsIgnoreCase(firstPart)) {
                  ipConntrack.setIcmpId(secondPart);
                } else if (ipConntrack.getIcmpType() <= 0 && "type".equalsIgnoreCase(firstPart)) {
                  ipConntrack.setIcmpType(Integer.parseInt(secondPart));
                } else if (ipConntrack.getIcmpCode() <= 0 && "code".equalsIgnoreCase(firstPart)) {
      ...
      ReportingUtils.reportException(null,
          new IllegalStateException("Error when parsing IP Conntrack raw: " + raw, e));
      return null;
    }
  ...
  @Nullable public String getRawLine() {
    return rawLine;
  }
  ...
  @Nullable public String getIcmpId() {
    return icmpId;
  }
  ...
  @Nullable public String getTransportProtocol() {
  ...
  @Nullable public String getTcpConnectionState() {
  ...
  @Nullable public String getSourceAddressOriginalSide() {
  ...
  @Nullable public String getDestinationAddressOriginalSide() {
  ...
  @Nullable public String getSourceAddressReplySide() {
  ...
  @Nullable public String getDestinationAddressReplySide() {
  ...
  @Nullable public String getSourceHostname() {
  ...
  @Nullable public String getDestWhoisOrHostname() {
  ...
  @Override public boolean equals(Object o) {
    ...
    if (destWhoisOrHostname != null ? !destWhoisOrHostname.equals(that.destWhoisOrHostname)
        : that.destWhoisOrHostname != null) {
      return false;
    }
    if (destinationAddressOriginalSide != null ? !destinationAddressOriginalSide.equals(
        that.destinationAddressOriginalSide) : that.destinationAddressOriginalSide != null) {
      return false;
    }
    if (destinationAddressReplySide != null ? !destinationAddressReplySide.equals(
        that.destinationAddressReplySide) : that.destinationAddressReplySide != null) {
      return false;
    }
    if (icmpId != null ? !icmpId.equals(that.icmpId) : that.icmpId != null) return false;
    if (sourceAddressOriginalSide != null ? !sourceAddressOriginalSide.equals(
        that.sourceAddressOriginalSide) : that.sourceAddressOriginalSide != null) {
      return false;
    }
    if (sourceAddressReplySide != null ? !sourceAddressReplySide.equals(that.sourceAddressReplySide)
        : that.sourceAddressReplySide != null) {
      return false;
    }
    if (sourceHostname != null ? !sourceHostname.equals(that.sourceHostname)
        : that.sourceHostname != null) {
      return false;
    }
    if (tcpConnectionState != null ? !tcpConnectionState.equals(that.tcpConnectionState)
        : that.tcpConnectionState != null) {
      return false;
    }
    if (transportProtocol != null ? !transportProtocol.equals(that.transportProtocol)
  ...
  @Override public int hashCode() {
    ...
    result = 31 * result + (sourceAddressOriginalSide != null ? sourceAddressOriginalSide.hashCode()
        : 0);
    result = 31 * result + (destinationAddressOriginalSide != null
        ? destinationAddressOriginalSide.hashCode() : 0);
    ...
    result =
        31 * result + (destinationAddressReplySide != null ? destinationAddressReplySide.hashCode()
            : 0);
  ...
  @Override public String toString() {
    return "IPConntrack{"
        ...
        + destinationAddressOriginalSide
        + '\''
        + ", sourcePortOriginalSide="
        + sourcePortOriginalSide
        + ", destinationPortOriginalSide="
        + destinationPortOriginalSide
        + ", hasSeenTrafficInBothDirections="
        + hasSeenTrafficInBothDirections
        + ", sourceAddressReplySide='"
        + sourceAddressReplySide
        + '\''
        + ", destinationAddressReplySide='"
        + destinationAddressReplySide
        + '\''
        + ", sourcePortReplySide="
        + sourcePortReplySide
        + ", destinationPortReplySide="
        + destinationPortReplySide
        + ", assured="
        + assured
        + ", structUseCount="
