...
public class NVRAMInfo extends RouterData<Properties> implements Serializable {
   ...
   */
  @SuppressWarnings("ConstantConditions") public void clear() {
    super.getData().clear();
  }
   ...
   */
  @NonNull @SuppressWarnings("ConstantConditions") public NVRAMInfo setProperty(
   ...
   */
  @Nullable @SuppressWarnings("ConstantConditions") public String getProperty(
   ...
   */
  @Nullable @SuppressWarnings("ConstantConditions") public String getProperty(
      @NonNull final String name, @Nullable final String defaultValue) {
   ...
   */
  @NonNull public NVRAMInfo setException(@Nullable final Exception exception) {
   ...
   */
  @SuppressWarnings("ConstantConditions") public void putAll(@Nullable final NVRAMInfo nvramInfo) {
    if (nvramInfo == null) {
      return;
    }
   ...
   */
  @SuppressWarnings("ConstantConditions") public boolean isEmpty() {
