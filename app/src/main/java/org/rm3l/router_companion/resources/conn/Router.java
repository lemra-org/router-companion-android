...
public class Router implements Serializable {
    ...
    @NonNull
    public static Set<Pair<String, String>> getAliases(@Nullable final Context context,
    ...
    @NonNull
    public static String getCanonicalHumanReadableNameWithEffectiveInfo(final Context ctx,
    ...
    @Nullable
    public static String getRouterModel(@Nullable final Context context,
                            ...
                            new Target() {
                                ...
                                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                                    ...
                                    if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1 &&
                                        ...
                                        boolean exists = false;
                                        final List<ShortcutInfo> pinnedShortcuts = shortcutManager
                                                .getPinnedShortcuts();
                                        for (final ShortcutInfo pinnedShortcut : pinnedShortcuts) {
                                            if (pinnedShortcut == null) {
                                                continue;
                                        ...
                                        if (exists) {
                                            final ShortcutInfo pinShortcutInfo = new ShortcutInfo.Builder(
                                                    ...
                                                    .build();
                                            shortcutManager
                                                    .updateShortcuts(Collections.singletonList(pinShortcutInfo));
                                        } else {
