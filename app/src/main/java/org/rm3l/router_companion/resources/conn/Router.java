...
public class Router implements Serializable {
  ...
  public Router(@Nullable final Context ctx, @Nullable final Router router) {
    ...
    this.sessionsCache = CacheBuilder.newBuilder()
        ...
        .build(new CacheLoader<RouterForSessionCache, Session>() {
          @Override public Session load(@NonNull RouterForSessionCache key) throws Exception {
            ...
            switch (sshAuthenticationMethod) {
              case PUBLIC_PRIVATE_KEY:
                ...
                jsch.addIdentity(key.router.getUuid() + "_" + login + "_" + port + "_" + ip,
                    !isNullOrEmpty(privKey) ? privKey.getBytes() : null, null,
  ...
  @NonNull public static String getCanonicalHumanReadableNameWithEffectiveInfo(final Context ctx,
      final Router router, final boolean displayPort) {
    if (Utils.isDemoRouter(router)) {
      return ("(DEMO) " + router.getDisplayName());
    }
    return String.format("%s (%s%s)", router.getDisplayName(), getEffectiveRemoteAddr(router, ctx),
        displayPort ? (":" + getEffectivePort(router, ctx)) : "");
  }

  @Nullable public static String getEffectiveRemoteAddr(@Nullable final Router router,
  ...
  @Nullable public static Integer getEffectivePort(@Nullable final Router router,
      @Nullable final Context ctx) {
    if (router == null || ctx == null) {
      return null;
    }
  ...
  @Nullable public static LocalSSIDLookup getEffectiveLocalSSIDLookup(@Nullable final Router router,
      @Nullable final Context ctx) {
    if (router == null || ctx == null) {
      return null;
    }
    ...
    if (!localSSIDLookupData.isEmpty()) {
      for (final Router.LocalSSIDLookup localSSIDLookup : localSSIDLookupData) {
        ...
        if (networkSsid.equals(currentNetworkSSID) || ("\"" + networkSsid + "\"").equals(
            currentNetworkSSID)) {
  ...
  @Nullable public static String getRouterModel(@Nullable final Context context,
      @Nullable final Router routerAt) {
  ...
  @NonNull public static Set<Pair<String, String>> getAliases(@Nullable final Context context,
  ...
  @SuppressLint("DefaultLocale") public static void openSSHConsole(@Nullable final Router router,
   ...
   */
  @NonNull public RouterConnectionProtocol getRouterConnectionProtocol() {
   ...
   * @return this object
   */
  @NonNull public Router setRouterConnectionProtocol(
   ...
   */
  @Nullable public String getUsernamePlain() {
    return d(username);
  }
   ...
   * @return this object
   */
  @NonNull public Router setUsername(@NonNull final String username, final boolean encrypt) {
    //noinspection ConstantConditions
   ...
   * @return the password
   */
  @Nullable public String getPasswordPlain() {
   ...
   * @return this object
   */
  @NonNull public Router setPassword(@Nullable final String password, final boolean encrypt) {
   ...
   * @return this object
   */
  @NonNull public Router setName(@Nullable final String name) {
    this.name = name;
    return this;
  }
  ...
  @NonNull public String getCanonicalHumanReadableName() {
  ...
  @NonNull public String getCanonicalHumanReadableNameWithEffectiveInfo(final boolean displayPort) {
   ...
   * @return this object
   */
  @NonNull public Router setRemoteIpAddress(@NonNull final String remoteIpAddress) {
   ...
   * @return this object
   */
  @NonNull public Router setRemotePort(final int remotePort) {
   ...
   * @return this object
   */
  @NonNull public Router setUuid(@NonNull final String uuid) {
    this.uuid = uuid;
    return this;
  }
   ...
   * @return the privKey
   */
  @Nullable public String getPrivKey() {
    return privKey;
  }
   ...
   */
  @Nullable public String getPrivKeyPlain() {
   ...
   * @return this object
   */
  @NonNull public Router setPrivKey(@Nullable final String privKey, final boolean encrypt) {
    this.privKey = \"fake-key\";
    return this;
  }
   ...
   * @return this object
   */
  @NonNull public Router setId(int id) {
    this.id = id;
    return this;
  }
  ...
  @Override public boolean equals(@Nullable Object o) {
    ...
    if (privKey != null ? !privKey.equals(router.privKey) : router.privKey != null) return false;
  ...
  @NonNull public SSHAuthenticationMethod getSshAuthenticationMethod() {
  ...
  @Nullable public RouterFirmware getRouterFirmware() {
  ...
  @NonNull private Pair<String, Integer> getEffectiveIpAndPortTuple() {
  ...
  @Nullable public Session getSSHSession() throws Exception {
  ...
  @NonNull public Collection<LocalSSIDLookup> getLocalSSIDLookupData(@NonNull final Context ctx) {
    final SharedPreferences sharedPreferences =
        ctx.getSharedPreferences(this.getUuid(), Context.MODE_PRIVATE);
  ...
  public void setLocalSSIDLookupData(@NonNull final Context ctx,
      Collection<LocalSSIDLookup> localSSIDLookups) {
    final SharedPreferences sharedPreferences =
        ctx.getSharedPreferences(this.getUuid(), Context.MODE_PRIVATE);
  ...
  @Nullable public String getRouterModel() {
    return routerModel;
  }
  ...
  @Nullable public SharedPreferences getPreferences(@Nullable final Context ctx) {
    return getPreferences(this, ctx);
  }

  @NonNull public Set<Pair<String, String>> getAliases(@Nullable final Context context) {
  ...
  public RouterInfo toRouterInfo() {
    return new RouterInfo().setId(this.id)
        .setUuid(this.uuid)
        .setName(this.name)
  ...
  public enum RouterConnectionProtocol {
     ...
     */
    RouterConnectionProtocol(@NonNull final String channel, final int defaultPort,
        @Nullable final String defaultUsername, @Nullable final String defaultPassword) {
  ...
  public enum SSHAuthenticationMethod {
    NONE, PASSWORD, PUBLIC_PRIVATE_KEY;
  }
  ...
  private class RouterShortcutAvatarDownloader implements Target {
    ...
    @Override public void onPrepareLoad(android.graphics.drawable.Drawable placeHolderDrawable) {
