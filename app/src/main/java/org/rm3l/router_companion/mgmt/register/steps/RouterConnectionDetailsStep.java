...
public class RouterConnectionDetailsStep extends MaterialWizardStep {
  ...
  @ContextVariable private String authMethod;

  private RadioGroup authMethodRg;

  @ContextVariable private String connectionProtocol;

  private Spinner connectionProtocolView;

  private DDWRTCompanionDAO dao;

  @ContextVariable private String password;

  @ContextVariable private String port;

  private EditText portEt;

  @ContextVariable private String privkeyButtonHint;

  private Button privkeyButtonView;

  @ContextVariable private String privkeyErrorMsg;

  private TextView privkeyErrorMsgView;

  @ContextVariable private String privkeyPath;
  ...
  @ContextVariable private String username;
  ...
  public View onCreateView(
    ...
    pwdShowCheckBox.setOnCheckedChangeListener(
    ...
    privkeyErrorMsgView.addTextChangedListener(
        new TextWatcher() {
          @Override
            ...
            new RadioGroup.OnCheckedChangeListener() {
              ...
              public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.router_add_ssh_auth_method_none) {
                  ...
                  pwdView.setVisibility(View.VISIBLE);
                  //                                pwdView.setHint("Key passphrase, if
                  // applicable");
                  pwdShowCheckBox.setVisibility(View.VISIBLE);
    ...
    privkeyButtonView.setOnClickListener(
