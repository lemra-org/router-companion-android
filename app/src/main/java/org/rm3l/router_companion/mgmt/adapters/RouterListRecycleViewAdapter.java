                ...
                if (TextUtils.isEmpty(constraint)) {
                    ...
                    oReturn.values = FluentIterable.from(routers).filter(new Predicate<Router>() {
                        ...
                        public boolean apply(Router input) {
                            ...
                            return (input.getName() != null && input.getName().toLowerCase()
                                    ...
                                    (routerFirmware != null && routerFirmware.toString().toLowerCase()
                                            .contains(constraintLowerCase)) ||
                                    (input.getUsernamePlain() != null && input.getUsernamePlain().toLowerCase()
                                            .contains(constraintLowerCase)) ||
                                    (routerConnectionProtocol != null &&
                                            routerConnectionProtocol.toString().toLowerCase()
                                                    .contains(constraintLowerCase));
                        }
                    }).toList();
                }
...
//        }
    ...
    @Override
    public void onItemDismiss(final RecyclerView mRecyclerView,
