...
public class DDWRTCompanionSqliteOpenHelper extends SQLiteOpenHelper {
    ...
    // Database creation sql statement
    private static final String TABLE_SPEED_TEST_RESULTS_CREATE = "CREATE TABLE IF NOT EXISTS "
    ...
    // Database creation sql statement
    private static final String TABLE_ACTIONS_AUDIT_LOG_CREATE = "CREATE TABLE IF NOT EXISTS "
    ...
    */
    ...
    private static final String[] DATABASE_TABLES_TO_CREATE = new String[]{
            DATABASE_CREATE, TABLE_WAN_TRAFFIC_CREATE, TABLE_SPEED_TEST_RESULTS_CREATE,
    ...
    static {
        ...
        DATABASE_UPGRADES.put(2,
                String.format("ALTER TABLE %s ADD COLUMN %s TEXT DEFAULT NULL; ", TABLE_ROUTERS,
                        ROUTER_FIRMWARE));
        //        DATABASE_UPGRADES.put(2,
        ...
        DATABASE_UPGRADES.put(16,
                String.format("ALTER TABLE %s ADD COLUMN %s INTEGER NOT NULL DEFAULT 1000; ", TABLE_ROUTERS,
                        ORDER_INDEX));
        //Migrate
        DATABASE_UPGRADES.put(18,
                String.format("UPDATE %s SET %s = (0 - %s); ", TABLE_ROUTERS, ORDER_INDEX, COLUMN_ID));

        //Support ordering in lists
        DATABASE_UPGRADES.put(20, String.format(
