...
public class RouterInfoForFeedbackServiceTask extends AbstractBackgroundServiceTask {
  ...
  @Override public void runBackgroundServiceTask(@NonNull Router router) throws Exception {
    ...
    final String[] manualProperty =
        SSHUtils.getManualProperty(mCtx, router, globalPreferences, "uname -a",
    ...
    String kernel = null;
    final String kernelFromPrefs = routerPreferences.getString(NVRAMInfo.KERNEL, DEFAULT_VALUE);
    ...
    final String ddwrtRevFromPrefs = routerPreferences.getString(NVRAMInfo.REVISION, DEFAULT_VALUE);
