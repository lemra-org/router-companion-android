...
public class ToggleWANAccessPolicyRouterAction extends AbstractRouterAction<Void> {
  ...
  @NonNull private final WANAccessPolicy mWanAccessPolicy;

  public ToggleWANAccessPolicyRouterAction(
      Router router,
    ...
    super(
        ...
        listener,
        enableStatus == 0
            ? RouterAction.DISABLE_WAN_ACCESS_POLICY
            : RouterAction.ENABLE_WAN_ACCESS_POLICY,
    ...
    try {
      ...
      final String filterRuleValue =
          String.format(
              ...
              WANAccessPolicy.Companion.getDENY().equals(mWanAccessPolicy.getDenyOrFilter())
                  ? 1
                  : 0);
