...
public class ImportAliasesDialogFragment extends DialogFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mRouter =
        RouterManagementActivity.Companion.getDao(context)
    ...
    if (mRouterPreferences == null) {
      ReportingUtils.reportException(
          context, new IllegalStateException("mRouterPreferences == NULL"));
          ...
          .setOnClickListener(
              new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  ...
                  ImportAliasesDialogFragment.this.startActivityForResult(
                ...
                public void onClick(View view) {
                  ...
                  if (validForm) {
                    ...
                    SnackbarUtils.buildSnackbar(
                        activity,
                        String.format(
                            "Going to start importing aliases for '%s' (%s)...",
                        ...
                        new SnackbarCallback() {
                            ...
                            try {
                              if (tempFile == null) {
                                Utils.reportException(
                                    context, new IllegalStateException("tempFile is null"));
                              ...
                              final boolean isClearChecked =
                                  ((SwitchCompat)
                                          d.findViewById(R.id.router_import_aliases_clear_aliases))
                                      .isChecked();
                              if (isClearChecked) {
                          ...
                          public void onShowEvent(@Nullable Bundle bundle) throws Exception {
                            ...
                            try {
                              tempFile =
                                  File.createTempFile(
                                      "aliases_to_import_" + mRouter.getUuid(),
                                      ".json",
                                      context.getCacheDir());

                              Files.write(
                                  ByteStreams.toByteArray(mSelectedBackupInputStream), tempFile);
                              // FileUtils.copyInputStreamToFile(mSelectedBackupInputStream,
                              // tempFile);
  ...
  private boolean validateForm(@NonNull AlertDialog d) {
    if (mSelectedBackupInputStream == null) {
      ...
      Utils.scrollToView(
          (ScrollView) d.findViewById(R.id.router_import_aliases_scrollview), viewById);
