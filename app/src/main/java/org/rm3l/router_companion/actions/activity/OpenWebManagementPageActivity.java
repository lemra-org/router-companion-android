...
public class OpenWebManagementPageActivity extends WebActivity {
  ...
  @Override protected boolean autoOpenUrl() {
    return false;
  }
  ...
  @Override protected WebViewClient getWebClient() {
    return new WebViewClient() {
      ...
      @Override public void onReceivedSslError(WebView view, final SslErrorHandler handler,
      ...
      @Override public void onReceivedHttpAuthRequest(WebView view, final HttpAuthHandler handler,
  ...
  class WebManagementLoaderTask
    ...
    @Override protected WebManagementLoaderTask.Result doWork() {
      try {
    ...
    @Override protected void onProgressUpdate(Integer integer) {
