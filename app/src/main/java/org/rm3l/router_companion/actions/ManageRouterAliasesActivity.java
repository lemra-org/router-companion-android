...
public class ManageRouterAliasesActivity extends AppCompatActivity
  ...
  private static final String ADD_OR_EDIT_ROUTER_ALIAS_FRAGMENT =
      "ADD_OR_EDIT_ROUTER_ALIAS_FRAGMENT";
  ...
  private static void displayRouterAliasDialog(final ManageRouterAliasesActivity activity,
      final String macAddress, final String currentAlias,
      final DialogInterface.OnClickListener onClickListener) {
    final AddOrUpdateRouterAliasDialogFragment fragment =
        AddOrUpdateRouterAliasDialogFragment.newInstance(activity.mRouter, macAddress, currentAlias,
            onClickListener);
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    AdUtils.buildAndDisplayAdViewIfNeeded(this,
        (AdView) findViewById(R.id.router_aliases_list_adView));
    ...
    mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
      ...
      @Override public void onScrolled(RecyclerView recyclerView, int firstVisibleItem,
  ...
  private void doRefreshRoutersListWithSpinner(@NonNull final RecyclerViewRefreshCause cause,
    ...
    new Handler().postDelayed(new Runnable() {
      @Override public void run() {
        try {
          final ImmutableList<Pair<String, String>> allAliases =
              FluentIterable.from(Router.getAliases(ManageRouterAliasesActivity.this, mRouter))
                  .toList();
          ((RouterAliasesListRecyclerViewAdapter) ManageRouterAliasesActivity.this.mAdapter).setAliasesColl(
              allAliases);
          switch (cause) {
  ...
  @Override public boolean onCreateOptionsMenu(Menu menu) {
    ...
    final SearchView searchView =
        (SearchView) menu.findItem(R.id.router_aliases_list_refresh_search).getActionView();
    ...
    switch (action) {
      case RouterActions.EXPORT_ALIASES:
        ...
        SnackbarUtils.buildSnackbar(this, findViewById(android.R.id.content), Color.DKGRAY,
            String.format("File '%s' created!", outputFile.getAbsolutePath()), Color.GREEN, "Share",
            Color.WHITE, Snackbar.LENGTH_LONG, new SnackbarCallback() {
              @Override public void onShowEvent(@Nullable Bundle bundle) throws Exception {
              ...
              @Override public void onDismissEventActionClick(int event, @Nullable Bundle bundle)
                ...
                try {
                  ...
                  final Uri uriForFile =
                      FileProvider.getUriForFile(ManageRouterAliasesActivity.this,
                          RouterCompanionAppConstants.FILEPROVIDER_AUTHORITY, outputFile);
                  ManageRouterAliasesActivity.this.grantUriPermission(
                      ManageRouterAliasesActivity.this.getPackageName(), uriForFile,
                  ...
                  ManageRouterAliasesActivity.this.startActivity(Intent.createChooser(shareIntent,
                      ManageRouterAliasesActivity.this.getResources()
  ...
  static class RouterAliasesListRecyclerViewAdapter
    ...
    public RouterAliasesListRecyclerViewAdapter(final ManageRouterAliasesActivity activity,
      ...
      this.mPreferences =
          this.context.getSharedPreferences(this.mRouter.getUuid(), Context.MODE_PRIVATE);
      this.aliasesColl =
          FluentIterable.from(Router.getAliases(this.context, this.mRouter)).toList();

      this.mFilter = new Filter() {
        @Override protected FilterResults performFiltering(final CharSequence constraint) {
          final FilterResults oReturn = new FilterResults();
          final List<Pair<String, String>> aliases = FluentIterable.from(
              RouterAliasesListRecyclerViewAdapter.this.mRouter.getAliases(
                  RouterAliasesListRecyclerViewAdapter.this.context)).toList();
          ...
          if (TextUtils.isEmpty(constraint)) {
            ...
            //Filter aliases list
            oReturn.values =
                FluentIterable.from(aliases).filter(new Predicate<Pair<String, String>>() {
                  @Override public boolean apply(Pair<String, String> input) {
                    if (input == null) {
                      return false;
                    }
                    ...
                    try {
                      macouiVendor =
                          WirelessClientsTile.mMacOuiVendorLookupCache.getIfPresent(macAddr);
                    } catch (final Exception e) {
                      //No worries
                    }
    ...
    @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      // create a new view
      final View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.router_alias, parent, false);
    ...
    @Override public void onBindViewHolder(final ViewHolder holder, final int position) {
      ...
      final Pair<String, String> aliasPairAt = aliasesColl.get(position);
      ...
      MultiThreadingManager.getResolutionTasksExecutor().execute(new UiRelatedTask<MACOUIVendor>() {

        @Override @Nullable protected MACOUIVendor doWork() {
          try {
        ...
        @Override protected void thenDoUiRelatedWork(@Nullable final MACOUIVendor macouiVendor) {
          //Hide loading wheel
      ...
      holder.containerView.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View v) {
          displayRouterAliasDialog(context, mac, aliasStr, new DialogInterface.OnClickListener() {
            @Override public void onClick(DialogInterface dialog, int which) {
              if (context != null) {
                context.doRefreshRoutersListWithSpinner(RecyclerViewRefreshCause.DATA_SET_CHANGED,
                    null);
              }
            }
          });
    ...
    private void showRouterAliasPopupMenu(final View v, final String mac, final String aliasStr,
        final AlertDialog removeAliasEntryDialog) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
      ...
      @NonNull final TextView macAddress;
      @NonNull final TextView alias;
      final TextView oui;
      final ProgressBar ouiLoadingSpinner;
      @NonNull final ImageButton removeButton;
      @NonNull final ImageButton aliasMenu;
      final View containerView;
      @NonNull final ImageView avatarImageView;
      ...
      public ViewHolder(Context context, View itemView) {
        ...
        this.ouiLoadingSpinner =
            (ProgressBar) this.itemView.findViewById(R.id.router_alias_oui_loading);
  ...
  public static class AddOrUpdateRouterAliasDialogFragment extends DialogFragment {
    ...
    @NonNull
    public static AddOrUpdateRouterAliasDialogFragment newInstance(@NonNull final Router router,
        CharSequence mMacAddr, CharSequence mAlias,
        final DialogInterface.OnClickListener onClickListener) {
    ...
    @Override public void onStart() {
      ...
      if (d != null) {
        ...
        d.getButton(Dialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View view) {
            //Validate data
            final EditText macEditText =
                (EditText) d.findViewById(R.id.add_or_edit_router_alias_mac);
            ...
            final EditText aliasEditText =
                (EditText) d.findViewById(R.id.add_or_edit_router_alias_value);
            ...
            routerPreferences.edit()
                .putString(macValueToPersist, nullToEmpty(aliasEditText.getText().toString()))
                .apply();
