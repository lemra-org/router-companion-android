...
public class SpeedTestResultRecyclerViewAdapter
  ...
  static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View itemView) {
      ...
      this.detailsPlaceholderView =
          cardView.findViewById(R.id.speed_test_result_details_placeholder);
    }
  }
  ...
  public SpeedTestResultRecyclerViewAdapter(
      final SpeedTestActivity activity, final Router mRouter) {
  ...
  public void onBindViewHolder(final ViewHolder holder, final int position) {
    ...
    wanPingView.setCompoundDrawablesWithIntrinsicBounds(
        0,
        isThemeLight
            ? R.drawable.ic_settings_ethernet_black_24dp
            : R.drawable.ic_settings_ethernet_white_24dp,
        0,
        0);
    ...
    final String wanDlByteCountDisplaySize =
        (SpeedTestActivity.toHumanReadableSize(
                activity, mRouter, speedTestResult.getWanDl().longValue())
            + PER_SEC);
    ...
    final String wanUlByteCountToDisplaySize =
        (SpeedTestActivity.toHumanReadableSize(
                activity, mRouter, speedTestResult.getWanUl().longValue())
            + PER_SEC);
    ...
    containerView
        .findViewById(R.id.speedtest_result_delete)
        .setOnClickListener(
            new View.OnClickListener() {
              @Override
              public void onClick(View v) {
                    ...
                    .setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                          ...
                          public void onClick(final DialogInterface dialogInterface, final int i) {
                            ...
                            mDao.deleteSpeedTestResultByRouterById(
                                mRouterUuid, speedTestResult.getId());
