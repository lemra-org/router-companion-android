...
public class RestoreRouterDialogFragment extends DialogFragment {
  ...
  @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    builder.setTitle(
        String.format("Restore '%s' (%s)", mRouter.getDisplayName(), mRouter.getRemoteIpAddress()))
    ...
    if (activity instanceof DDWRTMainActivity) {
      builder.setNeutralButton("*Backup*", new DialogInterface.OnClickListener() {
        @Override public void onClick(DialogInterface dialogInterface, int i) {
          ((DDWRTMainActivity) activity).displayBackupDialog(
      ...
      d.getButton(Dialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View view) {
          ...
          if (validForm) {
            ...
            //For reporting
            ReportingUtils.reportException(getContext(),
                new AgreementToRestoreRouterFromBackup(activity));
            ...
            ActionManager.runTasks(
                new RestoreRouterFromBackupAction(mRouter, activity, new RouterActionListener() {
