...
class WOLRemoteViewsFactory
  ...
  public RemoteViews getViewAt(int position) {
    ...
    if (device == null) {
      ...
      rv.setTextViewText(
          R.id.widget_wol_host_item_device_details_nic_manufacturer, EMPTY_VALUE_TO_DISPLAY);
    } else {
      ...
      rv.setTextViewText(
          R.id.widget_wol_host_item_device_details_nic_manufacturer,
  ...
  public void onLoadComplete(
      @Nullable Loader<RouterData<ArrayList<Device>>> loader,
    ...
    if (data != null) {
      ...
      if (devices != null) {
        ...
        final Set<Device> sortedDevices =
            new TreeSet<>(
    ...
    try {
      mRouterPreferences
          .edit()
          .putStringSet(
              WOLWidgetService.WOL_BCAST_ADDRESSES_PREF_KEY, new HashSet<>(mBcastAddresses))
          .putString(
              WOLWidgetService.WOL_HOST_PREF_KEY,
  ...
  private void initDataLoader() {
    ...
    final RouterData<ArrayList<Device>> routerData =
        WakeOnLanTile.getArrayListRouterDataSync(
            null, mRouter, mContext, mBcastAddresses, mGlobalPreferences, mRouterPreferences);
