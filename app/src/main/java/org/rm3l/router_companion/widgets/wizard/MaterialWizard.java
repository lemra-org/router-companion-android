...
public abstract class MaterialWizard extends WizardFragment
  ...
  @NonNull protected abstract String getWizardTitle();

  @Nullable protected String getFirstStepWizardSubTitle() {
    return null;
  }
  ...
  @SuppressWarnings("unchecked") @Override public final WizardFlow onSetup() {
   ...
   */
  @Override public void onWizardComplete() {
  ...
  @Nullable protected Intent getActivityIntentToReturnUponClose() {
    return new Intent();
  }
  ...
  @Nullable protected String getPreviousButtonLabel() {
    return null;
  }

  @Nullable protected String getNextButtonLabel() {
    return null;
  }

  @Nullable protected String getFinishButtonLabel() {
    return null;
  }
