...
public abstract class MaterialWizardStep extends WizardStep implements WizardStepVerifiable {
   ...
   * Called whenever the wizard proceeds to the next step or goes back to the previous step
   */
  @Override public final void onExit(int exitCode) {
  }
  ...
  @SuppressWarnings("unchecked") private void doPersistContextVariableFields() {

    try {
      final SharedPreferences globalPrefs = getContext().getSharedPreferences(
