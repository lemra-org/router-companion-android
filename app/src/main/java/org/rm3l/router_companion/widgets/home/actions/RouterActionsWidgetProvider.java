...
import org.rm3l.router_companion.widgets.home.wol.WOLWidgetConfigureActivity;

/**
 * Implementation of App Widget functionality. App Widget Configuration implemented in {@link
 * WOLWidgetConfigureActivity WOLWidgetConfigureActivity}
 */
public class RouterActionsWidgetProvider extends AppWidgetProvider {

  public static final String ACTION_OPEN_ROUTER_ACTIVITY =
      "org.rm3l.ddwrt.widgets.home.actions.ACTION_OPEN_ROUTER_ACTIVITY";

  public static final String ACTION_REBOOT_ROUTER =
      "org.rm3l.ddwrt.widgets.home.actions.ACTION_REBOOT_ROUTER";
  ...
  public void onReceive(final Context context, final Intent intent) {
    ...
    if ((intentAction = intent.getAction()) == null) {
      Toast.makeText(context, "Unknown Router Action!", Toast.LENGTH_SHORT).show();
      super.onReceive(context, intent);
      return;
    }
  ...
  static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
    ...
    if (router == null) {
      ...
      rebootIntent.putExtra(
          ConfirmDialogAsActivity.MESSAGE,
      ...
      final PendingIntent rebootPendingIntent =
          PendingIntent.getActivity(context, 0, rebootIntent, PendingIntent.FLAG_UPDATE_CURRENT);
      views.setOnClickPendingIntent(R.id.actions_widget_reboot_action, rebootPendingIntent);

      //            final Intent rebootIntent = new Intent(context,
      // RouterActionsWidgetProvider.class);
      ...
      //            views.setOnClickPendingIntent(R.id.actions_widget_reboot_action,
      // rebootPendingIntent);
    }
