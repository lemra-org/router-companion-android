...
public class LongListWithCustomEditTextPreference extends LongListPreference {
  ...
  //                    "ListPreference requires an entries array and an entryValues array which are
  ...
  //                    if(prefs.getString(mContext.getString(R.string.SP_address),
  // "0").equals(entryValues[position])) {
  ...
  //                    String fromPref = prefs.getString(mContext.getString(R.string.SP_address),
  // "0");
  //                    boolean flag=false;
  ...
  //        }
  //        /*
  //         * This class just shows the information in row from the position and the PreferenceList
  // entries
  //         */
  //        class NormalHolder
  //        {
  ...
  //
  //                // also need to do something to check your preference and set the right button
  // as checked
  //
