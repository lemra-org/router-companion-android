...
public abstract class AbstractDDWRTSettingsActivity extends AppCompatActivity {
  ...
  @NonNull protected abstract PreferenceFragment getPreferenceFragment();

  @Nullable protected String getToolbarSubtitle() {
    return null;
  }

  @NonNull protected String getToolbarTitle() {
    return SETTINGS;
  }

  @Nullable protected String getRouterUuid() {
    return null;
  }
