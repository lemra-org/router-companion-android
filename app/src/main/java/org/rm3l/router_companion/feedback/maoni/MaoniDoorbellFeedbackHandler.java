...
public class MaoniDoorbellFeedbackHandler extends MaoniDoorbellListener implements Handler {
  ...
  private MaoniDoorbellFeedbackHandler(Activity activity, Builder builder, Router router) {
    ...
    super(builder.withAdditionalPropertiesProvider(new Callable<Map<String, Object>>() {
      ...
      @Override public CharSequence call() throws Exception {
        return null;
      }
    }));
  ...
  @Override protected String getUserEmail() {
  ...
  @Override public boolean onSendButtonClicked(Feedback feedback) {
    return super.onSendButtonClicked(feedback);
  }

  @Override public void onCreate(View rootView, Bundle savedInstanceState) {
    mEmailInputLayout =
  ...
  @Override public boolean validateForm(View view) {
    if (mEmail != null) {
