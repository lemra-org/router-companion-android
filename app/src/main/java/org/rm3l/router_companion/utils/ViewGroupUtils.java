...
public final class ViewGroupUtils {
  ...
  @Nullable public static ViewGroup getParent(@NonNull final View view) {
  ...
  public static void requestDisallowParentInterceptTouchEvent(View __v,
  ...
  @NonNull public static Rect getLocationOnScreen(@NonNull final View mView) {
  ...
  @NonNull public static PointF getTopLeftCorner(@NonNull final View view) {
  ...
  @NonNull public static PointF getTopRightCorner(@NonNull final View view) {
    final float src[] = new float[8];
    final float[] dst = new float[] {
        0, 0, view.getWidth(), 0, 0, view.getHeight(), view.getWidth(), view.getHeight()
    };
  ...
  @NonNull public static PointF getBottomLeftCorner(@NonNull final View view) {
    final float src[] = new float[8];
    final float[] dst = new float[] {
        0, 0, view.getWidth(), 0, 0, view.getHeight(), view.getWidth(), view.getHeight()
    };
  ...
  @NonNull public static PointF getBottomRightCorner(@NonNull final View view) {
    final float src[] = new float[8];
    final float[] dst = new float[] {
        0, 0, view.getWidth(), 0, 0, view.getHeight(), view.getWidth(), view.getHeight()
    };
  ...
  @Nullable public static Float dpFromPx(final Context context, final float px) {
  ...
  @Nullable public static Bitmap toBitmap(@Nullable final View view) {
    if (view == null) {
      return null;
    }
  ...
  public static void exportViewToFile(@NonNull final Context context, @NonNull final View view,
  ...
  public static void exportBitmapToFile(@NonNull final Context context,
    ...
    try {
      ...
      e.printStackTrace();
      Toast.makeText(context, context.getString(R.string.internal_error_please_try_again),
