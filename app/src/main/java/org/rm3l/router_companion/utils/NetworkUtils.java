...
public final class NetworkUtils {
  ...
  @NonNull public static Retrofit getRetrofitInstance(@Nullable final Context context,
  ...
  @NonNull public static <T> T createApiService(@Nullable final Context context,
