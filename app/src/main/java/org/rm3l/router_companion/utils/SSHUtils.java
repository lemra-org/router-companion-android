...
public final class SSHUtils {
    ...
    private static final List<String> MULTI_OUTPUT_NVRAM_VARS =
            Arrays.asList(NVRAMInfo.Companion.getSSHD_RSA_HOST_KEY(), NVRAMInfo.Companion.getSSHD_DSS_HOST_KEY(),
                    ...
                    NVRAMInfo.Companion.getOPENVPN_CA(), NVRAMInfo.Companion.getOPENVPN_CLIENT(),
                    NVRAMInfo.Companion.getOPENVPN_KEY(),
                    NVRAMInfo.Companion.getOPENVPN_TLSAUTH(), NVRAMInfo.Companion.getOPENVPN_CRT(),
        ...
        try {
            ...
            if (routerFirmware == null || RouterFirmware.AUTO.equals(routerFirmware)) {
                ...
                try {
                    ...
                    int i = 0;
                    for (Map.Entry<RouterFirmware, String> routerFirmwareCmdEntry : FIRMWARE_AUTODETECT_CMDS
                            .entrySet()) {
        ...
        if (fieldsToFetch == null || fieldsToFetch.length == 0) {
            ...
            for (final String fieldToFetch : fieldsToFetch) {
                ...
                for (final String multiOutputNvramVar : MULTI_OUTPUT_NVRAM_VARS) {
                    if (multiOutputNvramVar != null && fieldToFetch.toLowerCase()
                            .contains(multiOutputNvramVar.toLowerCase())) {
                        getMultiOutput = true;
                        break;
                    }
                }
