...
public final class ImageUtils {
  ...
  public static void downloadImageFromUrl(
    ...
    downloadImageFromUrl(
        context, url, imageView, null, placeHolderDrawable, errorPlaceHolderDrawable, callback);
  }
   ...
   */
  @Nullable
  public static Uri drawableToUri(@Nullable Context context, @DrawableRes final int drawableId) {
    if (context == null) {
      return null;
    }
  ...
  public static Bitmap encodeAsBitmap(
      String contents, BarcodeFormat format, int imgWidth, int imgHeight) throws WriterException {
    if (contents == null) {
      return null;
    }
  ...
  @Nullable
  public static TextDrawable getTextDrawable(
  ...
  public static void setTextDrawable(
      @Nullable final ImageView imageView,
  ...
  public static void updateNotificationIconWithRouterAvatar(
      @NonNull final Context mCtx,
    ...
    try {
      ...
      final RequestCreator requestCreator =
          picasso.load(Router.getRouterAvatarUrl(mCtx, router, DDWRTMainActivity.opts));
  ...
  static void downloadImageForRouter(
    ...
    try {
      ...
      final String routerModelNormalized =
          Strings.nullToEmpty(routerModel).toLowerCase().replaceAll("\\s+", "");
      ...
      downloadImageFromUrl(
          ...
          new Callback() {
            ...
            public void onError(Exception e) {
              ...
              reportException(
                  null,
                  new MissingRouterModelImageException(
