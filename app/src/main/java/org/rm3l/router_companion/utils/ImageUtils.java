...
public final class ImageUtils {
  ...
  @Nullable public static TextDrawable getTextDrawable(@Nullable final String key,
  ...
  @Nullable public static Bitmap encodeAsBitmap(String contents, BarcodeFormat format, int imgWidth,
