...
public final class Utils {
  ...
  public static void checkDataSyncAlllowedByUsagePreference(@Nullable final Context ctx) {
    ...
    //        final long dataUsageCtrl = ctx.getSharedPreferences(DEFAULT_SHARED_PREFERENCES_KEY,
    // MODE_PRIVATE)
  ...
  public static void displayMessage(
      @NonNull final Activity activity, final String msg, final Style style) {
  ...
  public static void displayMessage(
      @NonNull final Activity activity, final String msg, final int bgColor) {
  ...
  public static void displayUpgradeMessage(
      @NonNull final Context ctx,
      @Nullable final String featureTitle,
            ...
            new DialogInterface.OnClickListener() {
              ...
              public void onClick(final DialogInterface dialogInterface, final int i) {
                ...
                try {
                  ...
                  url =
                      "https://play.google.com/store/apps/details?id=" + AD_FREE_APP_APPLICATION_ID;
                }
  ...
  public static void downloadImageForRouter(
    ...
    ImageUtils.downloadImageForRouter(
        context, router, imageView, transformations, placeHolderRes, errorPlaceHolderRes, opts);
  }

  public static void downloadImageFromUrl(
      @Nullable Context context,
    ...
    ImageUtils.downloadImageFromUrl(
        context, url, imageView, placeHolderDrawable, errorPlaceHolderDrawable, callback);
  }
  ...
  public static Context getBaseContextToAttach(
      final Context rootCtx, @Nullable final Context base) {
  ...
  public static String getCommandForInternetIPResolution(
      Context context, @Nullable final String ncCmdPath) {
    ...
    return String.format(
        "(echo -e \""
            ...
            + "User-Agent:%s/%s\\r\\n\"; sleep 1) "
            + "| %s %s %d",
        PublicIPInfo.Companion.getICANHAZIP_HOST(),
        ...
        PublicIPInfo.Companion.getICANHAZIP_HOST(),
        PublicIPInfo.Companion.getICANHAZIP_PORT());
  }
  ...
  public static String getCommandForRevDnsPtrResolution(
      Context context, @Nullable final String ncCmdPath) {
    final CharSequence applicationName = Utils.getApplicationName(context);
    // "echo -e \"GET / HTTP/1.1\\r\\nHost:icanhazip.com\\r\\nUser-Agent:DD-WRT
    // Companion/3.3.0\\r\\n\" | nc icanhazip.com 80"
    return String.format(
        "(echo -e \""
            ...
            + "User-Agent:%s/%s\\r\\n\"; sleep 1) "
            + "| %s %s %d",
        PublicIPInfo.Companion.getICANHAZPTR_HOST(),
        applicationName != null ? applicationName : BuildConfig.APPLICATION_ID,
        BuildConfig.VERSION_NAME,
        (ncCmdPath == null || ncCmdPath.trim().isEmpty()) ? "/usr/bin/nc" : ncCmdPath,
        PublicIPInfo.Companion.getICANHAZPTR_HOST(),
        PublicIPInfo.Companion.getICANHAZPTR_PORT());
  }
  ...
  public static int getResId(String resourceName, Class<?> clazz) {
    try {
      ...
      //                Log.d(TAG, "XXX getResId(" + resourceName + ") : declaredFields for " +
      // clazz + " : " +
  ...
  public static String getShareIntentFooter() {
    return String.format(
        "<br/><br/>-- Generated by '<a href=\"%s\">DD-WRT Companion</a>'",
        RouterCompanionAppConstants.WEBSITE);
  }
  ...
  public static String getWifiName(Context context) {
    ...
    final ConnectivityManager connectivityManager =
        (ConnectivityManager)
            currentActivity.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    //        final NetworkInfo myNetworkInfo =
    ...
    final WifiManager wifiManager =
        (WifiManager)
            currentActivity.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    if (wifiManager == null) {
      return null;
    }
  ...
  /**
   * Check if Chrome CustomTabs are supported. Some devices don't have Chrome or it may not be
  ...
  public static boolean isChromeCustomTabsSupported(@NonNull final Context context) {
    final Intent serviceIntent = new Intent("androidx.customtabs.action.CustomTabsService");
    serviceIntent.setPackage("com.android.chrome");

    final CustomTabsServiceConnection serviceConnection =
        new CustomTabsServiceConnection() {
          @Override
          public void onCustomTabsServiceConnected(
              final ComponentName componentName, final CustomTabsClient customTabsClient) {}
  ...
  public static void openFeedbackForm(final Activity activity, final Router router) {
    ...
    final Builder maoniBuilder =
        new Builder(activity, RouterCompanionAppConstants.FILEPROVIDER_AUTHORITY)
            .withTheme(
    ...
    switch (Objects.requireNonNull(
            ContextUtils.getConfigProperty(activity, "MAONI_FEEDBACK_PROVIDER", ""))
        .toLowerCase()) {
      case "doorbell.io":
        maoniBuilder.withHandler(new MaoniFeedbackHandler(activity, router));
        break;
      case "email":
        final String toAddressesString =
            Objects.requireNonNull(
                ContextUtils.getConfigProperty(activity, "MAONI_FEEDBACK_EMAIL_TO_ADDRESSES", ""));
  ...
  public static void openFeedbackForm(final Activity activity, final String routerUuid) {
    openFeedbackForm(
        activity, RouterManagementActivity.Companion.getDao(activity).getRouter(routerUuid));
  }
  ...
  public static void scrollToView(
      @Nullable final ScrollView scrollView, @Nullable final View view) {
  ...
  public static String truncateText(
      @Nullable final String str, final int maxLen, final int lenFromEnd) {
    int len;
