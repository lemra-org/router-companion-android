...
public final class Utils {
  ...
  @Nullable public static CharSequence getApplicationName(@Nullable Context context) {
    if (context == null) {
      return null;
    }
  ...
  @NonNull public static String[] getLines(@NonNull BufferedReader bufferedReader)
      throws IOException {
  ...
  @NonNull public static AlertDialog buildAlertDialog(@NonNull final Context context,
  ...
  @NonNull public static String decimalToIp4(long ip) {
  ...
  @NonNull public static long ip4ToDecimal(@NonNull final int[] ipParts) {
    if (ipParts.length != 4) {
  ...
  @Nullable public static InetAddress getBroadcastAddress(@Nullable final WifiManager wifiManager)
      throws IOException {
    if (wifiManager == null) {
      return null;
    }
  ...
  @Nullable public static String getAppOriginInstallerPackageName(@NonNull final Context context) {
    try {
   ...
   */
  @NonNull public static String getEscapedFileName(@NonNull final String filename) {
  ...
  @Nullable public static String getWifiName(Context context) {
    if (context == null) {
      return null;
    }
  ...
  @Nullable public static View getLineView(@Nullable Context ctx) {
  ...
  @Nullable public static Integer getStatusBarHeight(@NonNull final Context context) {
    Integer result = null;
  ...
  @NonNull public static Pair<String, String> handleException(@Nullable final Exception exception) {
    if (exception == null) {
  ...
  public static boolean isChromeCustomTabsSupported(@NonNull final Context context) {
    ...
    final CustomTabsServiceConnection serviceConnection = new CustomTabsServiceConnection() {
      @Override public void onCustomTabsServiceConnected(final ComponentName componentName,
  ...
  @Nullable public static String truncateText(@Nullable final String str, final int maxLen,
  ...
  @Nullable public static String guessAppropriateEncoding(@NonNull final CharSequence contents) {
  ...
  @NonNull public static SharedPreferences getGlobalSharedPreferences(@NonNull final Context ctx) {
