...
public class CustomTabsHelper {
  ...
  private static final String EXTRA_CUSTOM_TABS_KEEP_ALIVE = "androidx.customtabs.extra.KEEP_ALIVE";
  ...
  public static void addKeepAliveExtra(Context context, Intent intent) {
    Intent keepAliveIntent =
        new Intent()
            .setClassName(context.getPackageName(), KeepAliveService.class.getCanonicalName());
