...
public final class SnackbarUtils {
  ...
  public static Snackbar buildSnackbar(
    ...
    final Snackbar snackbar =
        Snackbar.make(view, Strings.nullToEmpty(title), duration)
            .setAction(
                actionText,
                ...
                switch (event) {
                  ...
                  default:
                    Utils.reportException(
                        ctx, new IllegalStateException("Unknown Snackbar event: " + event));
                    break;
                }
              }
    ...
    group.setBackgroundColor(
        ContextCompat.getColor(
            ...
            ColorUtils.Companion.isThemeLight(context)
                ? R.color.lightTheme_primary
                : R.color.darkTheme_primary));
    return snackbar;
  }
