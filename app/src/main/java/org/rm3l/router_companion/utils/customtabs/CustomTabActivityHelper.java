...
public class CustomTabActivityHelper {
  ...
  public static void openCustomTab(@NonNull final Activity context,
      @Nullable final CustomTabsSession customTabsSession, @NonNull final String url,
      @Nullable final String routerUuid, @Nullable final String helpLink,
      @Nullable final CustomTabFallback fallback, boolean withFeedbackMenuItem) {
