...
public interface SnackbarCallback {
   ...
   */
  default void onDismissEventActionClick(int event, @Nullable final Bundle bundle)
      throws Exception {}
   ...
   * @param bundle data passed to the callback
   */
  default void onDismissEventConsecutive(int event, @Nullable final Bundle bundle)
      throws Exception {}

  /**
   * Snackbar was dismissed via a call to {@link Snackbar#dismiss()}
   *
