 ...
 * colors via {@link #setSelectedIndicatorColors(int...)} and {@link #setDividerColors(int...)}. The
...
public class SlidingTabLayout extends HorizontalScrollView {
  ...
  private void populateTabStrip() {
    // http://stackoverflow.com/questions/26362555/custom-selected-tab-text-color-in-slidingtablayout
  ...
  private void scrollToTab(int tabIndex, int positionOffset) {
    ...
    //
    //            if (tabIndex > 0 || positionOffset > 0) {
    //                // If we're not at the first child and are mid-scroll, make sure we obey the
    // offset
    //                targetScrollX -= mTitleOffset;
    //            }
    //
