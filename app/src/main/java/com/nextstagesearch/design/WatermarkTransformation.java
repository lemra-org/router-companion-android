...
/**
 * Created by oded on 9/15/15. Watermark Transformation for the Picasso image loading library
 * (https://github.com/square/picasso). The transformation will add the text you provide in the
 * constructor to the image. This was created to be implemented in http://wheredatapp.com, android's
 * greatest search engine.
 */
// Not used for now
public class WatermarkTransformation
