 ...
 */
@RunWith(MockitoJUnitRunner.class) public class UtilsTest {

  @Mock Context mMockContext;

  @Mock Activity mMockActivity;

  @Test public void testGetApplicationName_FromNullContext() {
    Assert.assertNull(Utils.getApplicationName(null));
  }

  @Test public void testGetApplicationName_FromNonNullContext() {
  ...
  @Test public void testOpenDonateActivity() {
  ...
  @Test public void testDecimalToIp4() {
  ...
  @Test(expected = IllegalArgumentException.class) public void testIp4ToDecimal_InvalidLength() {
  ...
  @Test public void testTruncateText_NullStr() {
  ...
  @Test public void testTruncateText_PositiveMaxLen() {
