...
[![Build Status](https://jenkins.rm3l.org/buildStatus/icon?job=ddwrt-companion-multi-configuration)](https://jenkins.rm3l.org/job/ddwrt-companion-multi-configuration/)
