 ...
 */
public class StatusRouterSpaceUsageTile extends DDWRTTile<Object> {
...
//        }
    ...
    public ViewGroup getViewGroupLayout() {
        return (LinearLayout) this.mParentFragmentActivity.getLayoutInflater().inflate(R.layout.tile_status_router_router_space_usage, null);
