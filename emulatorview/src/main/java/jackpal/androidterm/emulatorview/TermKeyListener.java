...
class TermKeyListener {
  ...
  private ModifierKey mAltKey = \"fake-key\";
  private ModifierKey mCapKey = \"fake-key\";
  private ModifierKey mControlKey = \"fake-key\";
  private ModifierKey mFnKey = \"fake-key\";
...
*/
  ...
  private void updateCursorMode() {
    mCursorMode =
        getCursorModeHelper(mCapKey, TextRenderer.MODE_SHIFT_SHIFT) | getCursorModeHelper(mAltKey,
            TextRenderer.MODE_ALT_SHIFT) | getCursorModeHelper(mControlKey,
            TextRenderer.MODE_CTRL_SHIFT) | getCursorModeHelper(mFnKey, TextRenderer.MODE_FN_SHIFT);
  }
